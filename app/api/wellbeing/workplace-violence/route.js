...
export async function POST(request) {
  ...
  try {
    ...
    const { record, deduplicated } = await createWorkplaceViolenceRecordForUser(auth.userId, body);
    ...
    return wellbeingErrorResponse(error, { label: "workplace-violence save failed" });
  }
}
