...
export const WELLBEING_TOOL_INFO_IDS = Object.freeze({
  "my-records": "wellbeing_my_records",
...
export const wellbeingTools = Object.freeze([
  {
    ...
    slug: "minu-kirjed",
    title: "Minu kirjed",
    description: "Vaata, jätka ja halda oma varasemaid tööheaolu kirjeid ja mustandeid.",
    icon: "History",
    infoId: WELLBEING_TOOL_INFO_IDS["my-records"],
    route: "/tooheaolu/minu-kirjed"
  },
  {
    id: "quick-check",
    slug: "kiirkontroll",
...
export function getWellbeingToolByRoute(route) {
  const normalized = String(route || "").trim();
  return wellbeingTools.find((tool) => tool.route === normalized) || null;
}
