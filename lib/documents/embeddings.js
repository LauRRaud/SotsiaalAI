...
import { assertDocumentRagIngestReady } from "@/lib/documents/ragPermission"
...
export async function ensureDocumentIndexed(document, observability = null, { db = prisma } = {}) {
  await assertDocumentRagIngestReady(document, { db })
