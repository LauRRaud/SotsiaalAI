...
export function diagnosticExplanationRows(diagnostic, translate) {
  ...
  if (diagnostic?.runtime?.configured_model) add("configured_model", diagnostic.runtime.configured_model);
  if (diagnostic?.runtime?.reasoning_effort) add("reasoning_effort", diagnostic.runtime.reasoning_effort);
