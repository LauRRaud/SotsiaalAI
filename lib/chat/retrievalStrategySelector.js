const STRATEGY_BY_MODE = Object.freeze({
  ...
  professional_method_guidance: {
    ...
    query_order: "authoritative_guidance_first",
    needs_multiple_sources: true,
    ...
    reason: "planner_mode_professional_method_guidance"
  },
  comparison: {
  ...
  person_source_lookup: {
    ...
    reason: "planner_mode_person_source_lookup"
  }
});
