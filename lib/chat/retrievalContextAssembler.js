    ...
    onTiming: timing => {
      ...
      retrievalTimings.push({
        ...
        observabilityStage: typeof timing.observabilityStage === "string"
          ...
          : null,
        embedding_duration_ms: Number.isFinite(Number(timing.embedding_duration_ms))
          ? Number(timing.embedding_duration_ms)
          : null,
        retriever_duration_ms: Number.isFinite(Number(timing.retriever_duration_ms))
          ? Number(timing.retriever_duration_ms)
          : null,
        retrieval_total_ms: Number.isFinite(Number(timing.retrieval_total_ms))
          ? Number(timing.retrieval_total_ms)
          : null,
