...
export async function assembleRetrievalContext({
  ...
  const questionPlan = canonicalRetrievalActive ? shadowQuestionPlan : originalQuestionPlan;
  ...
  return {
    ...
    retrievalMeta: {
      ...
      responseReplyLang: canonicalRetrievalActive
        ? languagePlan?.answerLanguage || replyLang
        : replyLang,
