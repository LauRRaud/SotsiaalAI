  ...
  if (shouldRunRag) {
    ...
    if (journalChunksPerDocument > 3) {
      ...
      if (numericFactEvidence.enabled) {
        ...
        extraSystemInstructions.push(
          "PERCENT_COUNT_SEMANTICS: kui tõendis on kuju X% (n=Y), käsitle n=Y allikas esitatud selle näitaja loendusena. Ära nimeta Y-d valimi suuruseks ja ära arvuta X% × Y põhjal uut inimeste arvu."
        );
