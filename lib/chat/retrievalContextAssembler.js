...
export function selectPersonSourceGroups(message = "", groups = [], k = CONTEXT_GROUPS_MAX, personName = null, intent = null) {
  ...
  return (intent === "authored_works" ? authored : [...authored, ...others]).slice(0, limit);
}
  ...
  if (shouldRunRag) {
    ...
    try {
      matches = await runRagSearch({
        ...
        multiQueryConcurrency: specificResearchFactQuestion ? 6 : 3,
        topK: ragSearchTopK,
