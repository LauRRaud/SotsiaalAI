...
export async function assembleRetrievalContext({
  ...
  const extraSystemInstructions = [
    ...
    ...(currentMunicipalityStaffingCountRequest ? [
      "CURRENT_MUNICIPAL_STAFFING_COUNT_MODE: vasta ainult SERVICE_MAP_KOV_CONTACTS-i ajakohaste avaldatud kontaktikirjete rolliloendi põhjal. Loenda küsitud rollid eraldi, selgita lühidalt rollinimetuste vastavust ja ära kasuta praeguse koosseisu arvutamiseks ajaloolist ajakirjaartiklit."
    ] : []),
