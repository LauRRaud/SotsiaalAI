...
export function detectCrisis(text = "") {
  ...
  const hits = [
    ...
    // (nt „enesetapumõtted" ühe p-ga, „tahan end tappa", „lõpetada oma elu") ---
    /enesetap|suitsii?d/,
    /\b(end|ennast|enda) ([äa]ra )?tappa|taha(n|ks|ksin) ([äa]ra )?surra/,
    /(oma )?elu ([äa]ra )?l[õo]petada|l[õo]petada (oma )?elu|(endale|enesele) l[õo]pp/,
    /vigasta(n|sin|ma|mas) (end|ennast)|(end|ennast) vigasta(n|sin|ma|mas)|l[õo]i(kun|gun|kasin) (end|ennast)/,
