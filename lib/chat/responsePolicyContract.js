// Browser-safe record validation for diagnostics. Reply text authorization remains server-side.
...
function hasValidatedGroupPublicationRecord(trace) {
...
export function hasValidatedDirectedRelationPublicationRecord(trace) {
  const decision = trace?.response_decision;
...
export function hasValidatedPublicationRecord(trace) {
  return hasValidatedGroupPublicationRecord(trace) || hasValidatedDirectedRelationPublicationRecord(trace);
}
