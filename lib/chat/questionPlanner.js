...
const RESEARCH_FACT_SOURCE_RE = /\b([a-z0-9]*uuring[a-z0-9]*|uurimus|uurimuse|uurimuses|uurimusest|artikkel|artikli|artiklis|artiklist|aruanne|aruande|aruandes|aruandest|raport|raporti|raportis|raportist|analuus|analuusi|analuusis|analuusist|kaardistus|kaardistuse|kaardistuses|kusitlus|kusitluse|kusitluses|e-kurs[a-z0-9-]*)\b/;
...
const RESEARCH_FACT_STOP_PREFIXES = Object.freeze([
  ...
  "seotud", "sinna", "tehakse", "tehti", "uuring", "uurimus", "valim", "vastaj", "hinnang", "kolm"
]);
