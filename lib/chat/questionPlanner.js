...
const REQUESTED_SLOT_RELATION_NOISE_RE = /^(?:aasta\p{L}*|year\p{L}*|год\p{L}*|artikl\p{L}*|kirjutis\p{L}*|aruand\p{L}*|raport\p{L}*|dokumend\p{L}*|uuring\p{L}*|uurimus\p{L}*|study|research|report|article|document|исследован\p{L}*|отч[её]т\p{L}*|стат\p{L}*|mida|mis|millis\p{L}*|millin\p{L}*|kuidas|millal|kelle|kes|kus|kohta|what|which|how|when|whose|who|where|ja|ning|voi|and|or|и|et|that|что|jargi|pohjal|according|oli|olid|on|is|are|was|were|nad|they|neid|these|those)$/u;
