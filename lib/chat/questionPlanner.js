...
const REQUESTED_QUALITATIVE_SLOT_CUE_RE = /(?<![\p{L}\p{N}])(?:mida|mis|milline|millised|millist|kuidas|millal|kelle|kes|kus|what|which|how|when|whose|who|where|какой|какая|какие|как|когда|чей|чья|чьи|кто|где)(?![\p{L}\p{N}])/gu;
