...
function isKovServiceAndLocalRuleQuestion(text = "", resolvedMunicipalities = [], morphology = null) {
...
export function buildQuestionPlan({
  ...
  if (isKovServiceAndLocalRuleQuestion(normalized, resolvedMunicipalities, morphology)) {
