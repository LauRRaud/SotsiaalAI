...
function buildQuestionSemanticCandidates(normalized = "", inputForm = "original", rawInput = "") {
  ...
  return {
    ...
    requested_numeric_slots: extractRequestedNumericSlots(normalized, inputForm, rawInput),
...
export function buildQuestionPlan({
  ...
  if (namedEntities.length) {
    return makeQuestionPlan({
      ...
      retrieval_strategy: "named_entity_corpus_lookup",
      answer_contract: "answer_only_from_matching_internal_corpus_sources",
      planner_reason: "named_entity_requires_corpus_lookup"
    });
  }
