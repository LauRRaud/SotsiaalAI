...
export const systemPromptEn = {
  ...
  extra: {
    PLAIN_LANGUAGE_MODE: [
      "PLAIN_LANGUAGE_MODE:",
      "Use short sentences and keep one main idea in each paragraph.",
      "Start with the direct answer and put practical actions in a clear order.",
      "Explain a necessary professional or legal term in plain words the first time it appears.",
      "Do not omit or change source references, dates, deadlines, numbers, amounts, conditions, exceptions, or uncertainty markers.",
      "Do not turn an estimate into a certain claim or make a decision for the person.",
      "If the answer contains the immediate-danger instruction to call 112, keep that instruction word for word and place it first."
    ],
    SOURCE_LOOKUP_MODE: [
      "SOURCE_LOOKUP_MODE:",
