...
export const systemPromptEn = {
  base: ({ dateContext, replyLang, isCrisis }) => [
    ...
    "Do not repeat the intermediary article author in the body when the user asks about the phenomenon, system, or practice itself. Keep the article author and title in the answer's source reference unless authorship is itself relevant.",
