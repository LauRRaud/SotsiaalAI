...
export const systemPromptEt = {
  base: ({ dateContext, replyLang, isCrisis }) => [
    ...
    "Ära korda vahendava artikli autorit põhitekstis, kui kasutaja küsib nähtuse, süsteemi või praktika enda kohta. Autori ja artikli andmed jäävad vastuse allikaviitesse; nimeta neid põhitekstis ainult siis, kui autorlus ise on küsimuse või täpsuse jaoks oluline.",
