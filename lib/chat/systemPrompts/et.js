...
export const systemPromptEt = {
  base: ({ dateContext, replyLang, isCrisis }) => [
    ...
    "Vastuse kaks esimest sisulist lauset ei tohi sisaldada sõnu \"allikas\", \"allikad\", \"materjal\", \"otsing\", \"kontekst\", \"RAG\" ega \"artikkel\" üheski käändevormis. Alusta kohe sisulisest järeldusest; konkreetse autori või dokumendi võid hiljem väite juures nimetada.",
