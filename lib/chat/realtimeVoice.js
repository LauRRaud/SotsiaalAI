...
const TRANSCRIPTION_PROMPTS = {
  et: "Vestlus toimub eesti keeles. Transkribeeri kogu kõnevoor täpselt eesti keeles, säilita nimed, arvud ja küsimused ning ära tõlgi.",
  en: "The conversation is in English. Transcribe the complete speech turn accurately, preserving names, numbers, and questions without translating.",
  ru: "Разговор идет на русском языке. Точно расшифруй всю реплику, сохраняя имена, числа и вопросы, без перевода."
};
...
export function buildRealtimeSessionConfig({
  ...
  const prompt = language ? TRANSCRIPTION_PROMPTS[language] : undefined;
  return {
    type: "transcription",
    audio: {
      input: {
        // Veebirakenduse tavakasutus on sülearvuti või ekraanist eemal oleva
        // mikrofoni kaudu; Realtime'i `far_field` on selleks ette nähtud.
