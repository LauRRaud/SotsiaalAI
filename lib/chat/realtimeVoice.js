...
/**
 * Realtime transcribes and detects turns only. It never authors the answer:
 * the completed transcript is sent through the existing chat/RAG/safety path.
 */
export function buildRealtimeSessionConfig({ locale, model = REALTIME_MODEL } = {}) {
  ...
  return {
    ...
    instructions: [
      ...
      "Do not answer the user and do not create a response.",
