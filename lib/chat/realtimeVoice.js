...
// TAGASI TÖÖTAVA PEALE. Vahetasin selle `gpt-4o-transcribe` vastu ja lisasin
// sõnavaravihje, et parandada eestikeelset transkriptsiooni — ja häälvestlus
// lakkas ÜLDSE töötamast (omanik 22.08: iga voor andis
// `conversation.item.input_audio_transcription.failed`). Kumb kahest muutusest
// süüdi oli, ei ole teada, sest mikrofoni ei saa siit katsetada. Seepärast:
// mõlemad tagasi, ja edasi ainult ÜKS muutus korraga, päris seansiga mõõdetuna.
// Mudel on env-iga vahetatav (OPENAI_REALTIME_TRANSCRIBE_MODEL), nii et
// katsetada saab ilma deploy'ta.
