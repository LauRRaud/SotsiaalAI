...
/* Eestikeelne transkriptsioon. Mini-mudel eksib lühikeste sõnadega mõõdetavalt:
   "Tere" -> "Tadaam", varem "Talveina" (omanik 22.08).

   Esimene katse vahetas KORRAGA mudeli ja lisas sõnavaravihje `prompt` —
   häälvestlus lakkas üldse töötamast ja kumb süüdi oli, jäi teadmata. Nüüd on
   muutuja ÜKS: mudel vahetub, `prompt` jääb lisamata. Kui vestlus kukub uuesti
   (iga voor annab `conversation.item.input_audio_transcription.failed`), siis
   ongi süüdi mudeliväli ja tagasitee on üks käsk serveris, ilma deploy'ta:
