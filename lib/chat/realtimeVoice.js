...
// Eesti keel on väikeressursiline: mini-mudel andis pikemate lausete peale
// hallutsinatsioone ("Talveina"), lühike "Tere" tuli õigesti. Suur mudel on
// siin mõõdetavalt parem; nimi on env-iga vahetatav, et whisper-1 saaks
// vajadusel A/B-da ilma deploy'ta.
export const REALTIME_TRANSCRIPTION_MODEL = "gpt-4o-transcribe";
export const REALTIME_VOICE = "marin";

// Sõnavaravihje transkribeerijale. Ilma selleta kirjutab mudel valdkonna
// terminid foneetiliselt ümber ja vastus läheb RAG-is mööda.
const TRANSCRIPTION_HINTS = {
  et: [
    "Eestikeelne vestlus sotsiaalvaldkonnast.",
    "Sagedased sõnad: sotsiaaltöötaja, lastekaitse, hoolekanne, toimetulekutoetus,",
    "erihoolekanne, koduteenus, tugiisik, isikliku abistaja teenus, eestkoste,",
    "sotsiaalhoolekande seadus, KOV, omavalitsus, ohvriabi, rehabilitatsioon,",
    "puude raskusaste, töövõimetoetus, sotsiaalkindlustusamet, supervisioon, kovisioon."
  ].join(" "),
  en: "Conversation about Estonian social work, welfare services and case management.",
  ru: "Разговор о социальной работе и услугах социального обеспечения в Эстонии."
};
    ...
    audio: {
      input: {
        ...
        transcription: {
          ...
          prompt: TRANSCRIPTION_HINTS[language] || TRANSCRIPTION_HINTS.et,
          ...(language ? { language } : {})
        },
