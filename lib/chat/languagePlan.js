...
export function buildChatLanguagePlan({
  ...
  return {
    ...
    answerLanguage: normalizedRuntimeAnswerLanguage,
    answerLanguageReason: normalizedRuntimeAnswerLanguage === recommendedAnswerLanguage
      ? recommendedAnswerReason
...
export function buildSafeLanguagePlanTrace(languagePlan = null, shadowQuestionPlan = null) {
