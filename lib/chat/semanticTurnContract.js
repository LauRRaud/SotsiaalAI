...
export function buildSemanticTurnContract({
  ...
  return {
    version: "semantic_turn_contract_v1",
    ...
    requested_facts: Array.isArray(questionPlan?.semantic_candidates?.requested_numeric_slots?.slots)
      ? questionPlan.semantic_candidates.requested_numeric_slots.slots.slice(0, 8)
      : [],
