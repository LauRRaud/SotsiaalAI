...
function sanitizeShadowPlannerField(value, sanitizeValue) {
  ...
  return {
    value: available ? sanitizeValue(value.value) : null,
    available,
    ...
    planner: {
      ...
      fields: {
        ...
        evidence_phase_ordinal: sanitizeShadowPlannerField(
          ...
          fieldValue => truncateTraceString(fieldValue, 40)
        ),
    ...
    fact_validation: factValidation && typeof factValidation === "object" ? {
      ...
      structured_observations: {
        ...
        evidence_period_years: Array.isArray(factStructured.evidence_period_years)
          ...
          : null,
        evidence_phase_ordinal: truncateTraceString(factStructured.evidence_phase_ordinal, 40),
        evidence_metric_term_count: Number.isInteger(Number(factStructured.evidence_metric_term_count))
          ? Number(factStructured.evidence_metric_term_count)
          : null,
