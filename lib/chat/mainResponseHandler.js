 ...
 */
function buildReplayResponse({ wantStream, convId, replay, isCrisis }) {
  ...
  const sse = new ReadableStream({
    async start(controller) {
      ...
      /* Aus Stop (T03 E2 + SOL-CHAT-05): serveripoolne abort salvestab AINULT juba VÄLJA SAADETUD
         osalise teksti tähisega ABORTED (või ausa tühja katkestuse), vabastab kasutamata
         reservatsiooni ega luba taustal valmivat täisvastust püsistada. Ei emiteeri `done`.
