...
export async function listPublishedHelpMapEntries({
  ...
  if (normalizedKeyword) {
    filters.AND.push({ OR: [
      ...
      { request: { is: { OR: [
        ...
        { structuredSummary: { contains: normalizedKeyword, mode: "insensitive" } }
      ] } } },
      { offer: { is: { OR: [
        { title: { contains: normalizedKeyword, mode: "insensitive" } },
        { description: { contains: normalizedKeyword, mode: "insensitive" } },
  ...
  if (normalizedRegion) {
    filters.AND.push({ OR: [
      ...
      { request: { is: { rawPlace: { contains: normalizedRegion, mode: "insensitive" } } } },
      { offer: { is: { rawPlace: { contains: normalizedRegion, mode: "insensitive" } } } }
    ] });
  }
