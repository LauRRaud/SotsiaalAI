...
export const DomainEventType = Object.freeze({
  ...
  NETWORK_SHARE_CHANGED: "network_share.changed",
  CASEWORK_DRAFT_EXTERNAL_TRANSFER_MARKED: "casework.draft.external_transfer_marked"
});
...
export const AudienceRule = Object.freeze({
  ...
  NETWORK_SHARE_PARTICIPANT: "network_share_participant"
});
...
export const EVENT_REGISTRY = Object.freeze({
  ...
  [DomainEventType.WORKSPACE_UPDATED]: spec({
    audienceRule: AudienceRule.OWNER,
    actionKind: ActionKind.OPEN_WORKSPACE,
    labelKey: "notifications.events.workspace_updated",
    emailPolicy: "NONE",
    workspaceKind: "journey",
    sourceFeature: "journeys",
    sourceType: "JOURNEY",
  ...
  [DomainEventType.NETWORK_SHARE_CHANGED]: spec({
    audienceRule: AudienceRule.NETWORK_SHARE_PARTICIPANT,
    actionKind: ActionKind.OPEN_NETWORK_SHARE,
    labelKey: "notifications.events.network_share_changed",
    emailPolicy: "NONE",
    workspaceKind: "network_share",
    sourceFeature: "networkShares",
    sourceType: "NETWORK_SHARE",
    projectionType: "NETWORK_SHARE_CHANGED",
    metaSchema: Object.freeze({
      statusCode: Object.freeze({
        kind: "enum",
        values: Object.freeze(["DRAFT", "AWAITING_CLIENT", "CONFIRMED", "DECLINED", "SENT", "OPENED", "RESPONDED", "RECALLED", "ENDED"])
      }),
      actionCode: Object.freeze({
        kind: "enum",
        values: Object.freeze(["CREATE", "UPDATE", "SUBMIT", "DECIDE", "ATTEST", "SEND", "OPEN", "RECALL", "RESPOND", "END"])
      }),
      recipientKind: Object.freeze({
        kind: "enum",
        values: Object.freeze(["NONE", "WORKER", "CLIENT", "RECIPIENT", "ALL"])
      })
    })
  }),
  /* JTA-V1 (E6, L9/L18). „Märgi üle kantuks" on AVALDUS selle kohta, et info on
     STAR-is — kopeerimine ei emiteeri midagi.

     `WORKSPACE_TIMELINE_ONLY` + `OWNER` tähendab NULL SAAJAT ja see on tahtlik
     (vt `recipients.js`): juhtum on rangelt isiklik (L2), seega ainus võimalik
     saaja oleks tegija ise — teavitus oma äsjase vajutuse kohta on müra. Sündmus
     on siin ajajoone ja auditi fakt, mitte teade.

     `AUDIT_LONG`, sest ta räägib ülekandest välisesse registrisse; tema eluiga
     on juhtumi oma (L8) ja juhtumi kustutus viib ta kaasa. */
  [DomainEventType.CASEWORK_DRAFT_EXTERNAL_TRANSFER_MARKED]: spec({
    audienceRule: AudienceRule.OWNER,
    actionKind: ActionKind.OPEN_WORKSPACE,
    labelKey: "notifications.events.casework_draft_external_transfer_marked",
    emailPolicy: "NONE",
    visibilityClass: VisibilityClass.PERSONAL,
    retentionClass: RetentionClass.AUDIT_LONG,
    workspaceKind: "case_work",
    sourceFeature: "casework",
    sourceType: "CASE_WORK_DRAFT",
    projectionType: "WORKSPACE_TIMELINE_ONLY",
    metaSchema: Object.freeze({})
  })
});
