...
import { retentionFieldsForSubmission } from "./retentionPolicy.js"
        ...
        for (const [index, file] of files.entries()) {
          ...
          const row = await tx.materialSubmission.create({
            data: {
              ...
              derivativeStoragePath: getSanitizedMaterialPath(finalPathFromJob(claim.jobs[index])),
              derivativeSha256: file.sanitizedSha256,
              derivativeSize: file.sanitizedBuffer.byteLength,
