...
export function serializeMaterialSubmission(submission) {
  ...
  return {
    ...
    retention: {
      class: submission.retentionClass || "DECISION_PENDING",
      until: submission.retentionUntil || null,
      policyVersion: submission.retentionPolicyVersion || null,
      state: submission.retentionState || "DECISION_PENDING",
      decisionPending: !submission.retentionUntil || submission.retentionState === "DECISION_PENDING"
    },
    rag: {
