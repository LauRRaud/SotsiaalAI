...
import { createLocalMaterialCdr } from "./cdr.js"

export const MATERIAL_SANITIZATION_VERSION = "materials-dangerzone-text-v1"
...
export const defaultMaterialSanitizer = createMaterialSanitizer({ cdr: createLocalMaterialCdr() })
