...
export const WORKSPACE_KIND_REGISTRY = Object.freeze({
  ...
  [WorkspaceKind.JOURNEY]: entry(WorkspaceKind.JOURNEY, WorkspaceKindStatus.RESERVED),
  ...
  [WorkspaceKind.FIELD_VISIT]: entry(WorkspaceKind.FIELD_VISIT, WorkspaceKindStatus.RESERVED),
