    ...
    details: [
      {
        ...
        itemKeys: [
          ...
          ["service_log.info.what_units", "Kui märgid saabumise ja lahkumise kellaaja, arvutab süsteem kestuse ise. Ühik tuleb teenuselt või suunamiselt — seda ei pea igal korral valima."],
      ...
      },
      {
        ...
        itemKeys: [
          ["service_log.info.day_flow", "Nuppe ei ole neli, vaid üks — ja tema kiri muutub: „Olen kohal“ → „Lahkusin“ → salvesta. Ekraan ütleb alati, kus sa jadas oled ja mis on järgmine samm."],
          ["service_log.info.day_travel", "Kui tahad sõiduaega arvestada, märgi see enne alustamist. Siis tuleb jada ette „Alustan sõitu“ ja lõppu „Jõudsin tagasi“. Valik lukustub esimese märke järel, et jada keskelt ei muutuks."],
