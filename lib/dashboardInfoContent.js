...
const DASHBOARD_INFO_ITEMS = Object.freeze({
  ...
  /* TEENUSPÄEVIK-V1 (leping 8.3: ⓘ on KOHUSTUSLIK). Tekstid tulevad
     ...
     Sisu vastab kahele küsimusele, mida osutaja päriselt küsib: mis siit välja
     tuleb (aruanne, mitte veel üks tabel) ja mida siia EI kirjutata. Teine on
     tähtsam: kirjemärge on lühike faktimärge, mitte juhtumilugu. */
  service_log: {
    ...
    details: [
      {
        ...
        itemKeys: [
          ...
          ["service_log.info.what_units", "Kui märgid saabumise ja lahkumise kellaaja, arvutab süsteem kestuse ise."]
        ]
      },
      {
        ...
        itemKeys: [
          ...
          ["service_log.info.privacy_retention", "Teenuskirje on arve alusdokument ja seda hoitakse 7 aastat. Ekslikku kirjet parandatakse, mitte ei kustutata."],
          ["service_log.info.privacy_location", "Asukohta ei salvestata. Kui omanik selle eraldi sisse lülitab, salvestatakse ainult üksik punkt kinnituse hetkel ja sulle näidatakse, mis salvestati — pidevat jälge ei koguta kunagi."]
        ]
      }
    ]
  }
