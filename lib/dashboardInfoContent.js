...
const DASHBOARD_INFO_ITEMS = Object.freeze({
  ...
  urgent_request: {
    title: "Kiireloomuline abipalve",
    aboutFeatureKey: "crisis_routing",
    details: [
      {
        title: "Millal seda rada kasutada",
        items: [
          "Kasuta seda siis, kui olukord ei kannata järgmise tavapärase vastuvõtuajani, kuid vahetut ohtu elule või tervisele ei ole.",
          "Kirjelda olukorda oma sõnadega ja kontrolli enne saatmist, milline vastuvõtulaud teksti loeb.",
          "Vahetu ohu korral ära saada vormi, vaid helista 112."
        ]
      },
      {
        title: "Pärast saatmist",
        body: "Näed abipalve olekut ning saad selle tagasi võtta seni, kuni vastuvõtja ei ole seda lugenud. Abipalve võib hiljem jätkuda eelpöördumisena."
      }
    ]
  },
  urgent_desk: {
    title: "Kiireloomuline vastuvõtt",
    aboutFeatureKey: "crisis_routing",
    details: [
      {
        title: "Vastuvõtja töö",
        items: [
          "Järjekord on ajaline: kõige kauem oodanud pöördumine on ees.",
          "Inimese muutmata sõnad ja AI koostatud mustand on alati eraldi märgistatud.",
          "Lugemine, vastutuse võtmine, keeldumine, üleandmine ja lõpetamine jäävad vastutusjälge."
        ]
      }
    ]
  },
  ...
  /* JUHTUM-V1 (leping E6). Sama reegel mis Teenuspäevikul: tekstid tulevad
     tõlkevõtmetest, sest pind on kolmes keeles ja ⓘ ei tohi olla ainus koht,
     mis jääb eesti keelde.

     Järjekord järgib töötaja küsimusi, mitte mudelit: milleks see on → mis
     juhtumi küljes on → mida seos tähendab → puuduv info → elutsükkel →
     kliendiviide. **Piirid on LÕPUS**, kuhu lugeja jõuab siis, kui ta juba
     teab, millest jutt — ja just need on kõige tähtsamad: juhtum ei ole
     register, ta on isiklik, teda ei anta üle ega kustutata. */
  casework: {
    titleKey: "casework.info.title",
    title: "Minu juhtumid",
    details: [
      {
        titleKey: "casework.info.what_title",
        title: "Milleks see on",
        itemKeys: [
          ["casework.info.what_container", "Juhtum on konteiner, mille ümber sinu töö käib: üks koht, kust näed, mis on pooleli, mis on puudu ja millal on järgmine kontakt."],
          ["casework.info.what_own", "See on SINU töökorraldus, mitte ametlik toimik. Ametlik kandja jääb STAR-i ja platvorm ei saada sinna midagi."],
          ["casework.info.what_manual", "Juhtumi loob alati inimene. Ükski pöördumine ega vestlus ei tekita juhtumit sinu eest."]
        ]
      },
      {
        titleKey: "casework.info.fields_title",
        title: "Mis juhtumi küljes on",
        itemKeys: [
          ["casework.info.fields_client", "Kliendiviide: kas platvormi kasutaja või sinu enda lühike märge — näiteks initsiaal, roll või välise registri tunnus. Ta võib ka puududa."],
          ["casework.info.fields_next_contact", "Järgmine kontakt: kuupäev ja kellaaeg, mille saab ka tühjaks jätta või hiljem eemaldada."],
          ["casework.info.fields_star", "STAR-i viide: süsteemi nimi ja viitenumber käivad alati koos. Sama viide tohib olla mitmel juhtumil."],
          ["casework.info.fields_items", "Seotud materjal: dokumendid, mustandid ja välitöökäigud."],
          ["casework.info.fields_missing", "Puuduv ja kontrollimist vajav info: loend, mis ütleb, mis on veel lahtine."]
        ]
      },
      {
        titleKey: "casework.info.links_title",
        title: "Seosed: juhtum seob, ei kopeeri",
        itemKeys: [
          ["casework.info.links_binds", "Siduda saab dokumendi, mustandi või välitöökäigu. Ühtegi rida ei kopeerita — juhtum viitab originaalile."],
          ["casework.info.links_access", "Siduda saab ainult seda, mida sa niikuinii juba näed, ja seos ise ei ava kunagi ligipääsu millelegi uuele."],
          ["casework.info.links_cascade", "Kui algobjekt kustub, kaob ka seos. Rippuvat viidet ei jää."]
        ]
      },
      {
        titleKey: "casework.info.missing_title",
        title: "Puuduv ja kontrollimist vajav info",
        itemKeys: [
          ["casework.info.missing_provenance", "Iga punkt kannab päritolu: kliendi öeldu, kliendi kinnitatud, dokumendist, teise spetsialisti info, töötaja tähelepanek, töötaja tõlgendus, AI mustand või ametlikult kontrollitud."],
          ["casework.info.missing_status", "Punkt on lahtine, lahendatud või „ei ole asjakohane“. Lahendamise aja paneb server; punkti tagasi avades ta kustub."],
          ["casework.info.missing_counter", "Lahtised punktid on loendis ees ja nende arv on juhtumi juures näha."]
        ]
      },
      {
        titleKey: "casework.info.lifecycle_title",
        title: "Elutsükkel",
        itemKeys: [
          ["casework.info.lifecycle_states", "Juhtum liigub ühes suunas: aktiivne → kirjutuskaitstud → arhiveeritud. Tagasiteed ei ole."],
          ["casework.info.lifecycle_reason", "Seisu muutmiseks tuleb kirjutada põhjus ja see jääb auditisse."],
          ["casework.info.lifecycle_children", "Kirjutuskaitse katab ka seosed ja puuduva info — lugeda saab edasi, muuta mitte."]
        ]
      },
      {
        titleKey: "casework.info.client_title",
        title: "Kliendiviide ja tema kustutamine",
        itemKeys: [
          ["casework.info.client_two_tracks", "Kontoga klient ja käsitsi kirjutatud viide on kaks eri rada ja neid ei ole korraga."],
          ["casework.info.client_no_search", "Kliendiotsingut ei ole: kontoga kliendiks saab märkida ainult inimese, kes selle pöördumise ise saatis."],
          ["casework.info.client_erase", "Kliendiviite saab kustutada igas seisus, ka kirjutuskaitstud ja arhiveeritud juhtumis. Väljad tühjenevad jäädavalt ja juhtumi nimeks jääb „Kustutatud kliendiviide“."]
        ]
      },
      {
        titleKey: "casework.info.privacy_title",
        title: "Mida siin EI ole",
        itemKeys: [
          ["casework.info.privacy_personal", "Juhtum on rangelt isiklik. Teine töötaja ei näe sinu juhtumit ega saa teada, kas ta üldse olemas on — ka admin ei näe sisu."],
          ["casework.info.privacy_no_transfer", "Juhtumit ei saa kolleegile üle anda ega kustutada."],
          ["casework.info.privacy_no_register", "See ei ole kliendiregister ega STAR-i koopia. Kirjuta siia nii vähe isikuandmeid, kui sinu enda töö nõuab."],
          ["casework.info.privacy_no_notifications", "Juhtum ei saada teavitusi ega jaga midagi automaatselt kellelegi teisele."]
        ]
      }
    ]
  },
  /* JTA-V1 laud (leping E2). Järjekord järgib töötaja küsimusi: milleks see on
     → mis laual on → miks sektsioon on tühi → mida siin EI ole.

     KOLMAS OSA ON SIIN OMAETTE ja seda ei ole üheski teises juhendis: laual on
     neli eri tühjuse põhjust (`EMPTY`, `FORBIDDEN`, `TIMEOUT`, `ERROR`) ja need
     tähendavad vastupidiseid asju. „Tööd ei ole" ja „allikas ei vastanud"
     näevad ekraanil ühesugused välja, kui neid ei seleta.

     PIIRID ON LÕPUS ja neid on neli, sest laud on täpselt see koht, kus
     koormuse mõõdik tekiks kogemata — ta juba loeb kõik allikad kokku (L3). */
  casework_workbench: {
    titleKey: "casework.workbench.info_title",
    title: "Juhtumitöö laud",
    details: [
      {
        titleKey: "casework.workbench.info_what_title",
        title: "Milleks see on",
        itemKeys: [
          ["casework.workbench.info_what_reader", "Laud on lugeja: ta koondab ühele pinnale selle, mis on juba olemas juhtumites, pöördumistes, jagamistes ja teemaseemnetes. Ise ta midagi ei salvesta."],
          ["casework.workbench.info_what_one_place", "See on päeva algusekraan — mis on saabunud, mis on täna, mis on puudu, mis ootab järge."],
          ["casework.workbench.info_what_act_elsewhere", "Tegu tehakse alati seal, kuhu rida viib. Laual ei ole ühtegi nuppu, mis midagi muudaks."]
        ]
      },
      {
        titleKey: "casework.workbench.info_sections_title",
        title: "Mis laual on",
        itemKeys: [
          ["casework.workbench.info_sections_today", "Tänased ja järgmised kontaktid on eraldi ning piir on Eesti kalendripäev, mitte serveri kell."],
          ["casework.workbench.info_sections_missing", "Puuduva info punktid kannavad päritolu — sama märgist, mis juhtumi enda loendis."],
          ["casework.workbench.info_sections_growing", "Laud kasvab etappide kaupa: STAR2-sse kandmist ootavad mustandid ja ülekandmise ajalugu lisanduvad hiljem. Seni ei kuvata neid tühja kastina, vaid neid lihtsalt ei ole."]
        ]
      },
      {
        titleKey: "casework.workbench.info_states_title",
        title: "Miks sektsioon on tühi",
        itemKeys: [
          ["casework.workbench.info_states_empty", "„Siin ei ole praegu midagi“ tähendab, et tööd ei ole."],
          ["casework.workbench.info_states_forbidden", "„Seda tööriista sinu rollil ei ole“ tähendab, et sektsioon ei kuulu sinu rolli juurde — mitte seda, et su töö on tehtud."],
          ["casework.workbench.info_states_timeout", "„Allikas ei jõudnud vastata“ tähendab, et laud ei jäänud teda ootama. Ülejäänud sektsioonid on ikka õiged."],
          ["casework.workbench.info_states_error", "Ühe allika tõrge ei võta lauda maha: katki on ainult see üks sektsioon ja ta ütleb seda välja."]
        ]
      },
      {
        titleKey: "casework.workbench.info_limits_title",
        title: "Mida siin EI ole",
        itemKeys: [
          ["casework.workbench.info_limits_personal", "Laud on rangelt isiklik. Ta näitab ainult sinu enda tööd ega ütle kellelegi teisele, mis siin seisab."],
          ["casework.workbench.info_limits_no_workload", "See EI ole koormuse mõõdik. Siin ei ole mahajäämust, keskmisi, tähtaja ületamise märgiseid ega võrdlust eelmise perioodiga — ja neid ei tule."],
          ["casework.workbench.info_limits_no_others", "Sa ei näe kellegi teise lauda ja keegi teine ei näe sinu oma. Ka administraator ei näe sisu."],
          ["casework.workbench.info_limits_no_ai", "AI siin midagi ei otsusta ega järjesta. Järjekord on ajaline ja loendid tulevad allikatest, mitte mudelilt."]
        ]
      }
    ]
  }
