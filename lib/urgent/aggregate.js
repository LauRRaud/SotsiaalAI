 ...
 *
 * Alla läve rühmade kohta ei väljasta koond ka metaandmeid. Nende arv või
 * skaneeritud ridade arv eristaks tühja valimit alla läve aktiivsusest ja
 * muudaks summutuse sisuliselt olemasolusignaaliks.
 */
export async function buildUrgentRequestAggregate({
  ...
  return {
    ...
    regions,
    hourBuckets,
    /* SOL-URG-11: tehniline kärpimine on NÄHTAV. Erinevalt summutatud rühmade
       arvust ei näita see alla läve aktiivsuse olemasolu, vaid seda, et vastuse
       katvus ei ole täielik. */
    truncated,
