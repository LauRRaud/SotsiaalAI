...
export async function resolveOrgAccessContext(
  ...
  /* T25 viil B: kas organisatsioon maksab SELLE inimese töötajakoha eest?
     ...
     KOHT ÜKSI EI PIISA (SOL-ORG-05). Varem küsis see päring ainult aktiivset
     kohta ja mitte tema VANEMPLAANI. Lõpetatud plaani alla jäänud aktiivne koht
     tegi organisatsioonist endiselt maksja — arveldustõde ja ligipääsutõde
     lahknesid, ja lahknemise suund oli alati sama: organisatsioon maksis
     ligipääsu eest, mida ta enam ei tellinud.

     Kaks tingimust on eri asjad ja mõlemad on vajalikud: `status: ACTIVE` ütleb,
     et plaani ei ole lõpetatud, `validUntil` ütleb, et ta ei ole aegunud.
     Aegunud plaan võib jääda `ACTIVE`-ks kuni keegi ta lõpetab. */
