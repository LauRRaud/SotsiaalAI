...
/**
 * Käivitab töö tehingus — VÕI juba avatud tehingu sees.
 *
 * MIKS: `recallInboxItemForSource` kutsutakse kahest kohast. Eelpöördumise
 * tagasivõtmine kutsub teda OMA tehingu seest (`withPreInquiryRoomLock`), sest
 * pöördumise ja postkastikirje tagasivõtmine peavad õnnestuma koos või mitte
 * kumbki. Prisma tehinguklient EI OMA `$transaction`-it, seega pesastatud
 * kutse viskaks. See kontroll teeb funktsiooni mõlemas kontekstis ohutuks.
 */
