...
import { normalizeWellbeingAnalysisUnit } from "./aggregate.js";
...
export function resolveWellbeingPilotAggregateFilters(filters = {}, access = {}) {
  ...
  const normalized = {
    ...
    /* SOL-WB-04: `normalized` on range valge nimekiri ja just seepärast pidi
       ühik siia nimeliselt jõudma — muidu oleks päringu parameeter kadunud
       vaikselt ja klient oleks saanud vaikeühiku ilma ühegi märguandeta.
       Tundmatu väärtus viskab 400, sama poliitika mis perioodivõrgul. */
    analysisUnit: normalizeWellbeingAnalysisUnit(filters.analysisUnit),
