...
/**
 * CSV-tekst tagasi ridadeks eelvaate jaoks. Eraldaja ja reavahetus lõpetavad
 * välja ainult väljaspool jutumärke; kahekordne jutumärk annab ühe jutumärgi.
 */
export function parseCsvRows(value, { delimiter = ";", maxRows = Infinity } = {}) {
  ...
  if (rows.length < maxRows && (field !== "" || row.length > 0)) finishRow();
  return rows;
}
