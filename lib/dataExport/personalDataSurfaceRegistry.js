...
const EXPORTED_RELATIONS = Object.freeze({
  ...
  covisionPrivateStates: ["covision_private_states"],
  supervisionPrivateItems: ["supervision_private_items"],
  supervisionPersonalOutcomes: ["supervision_personal_outcomes"]
});
...
const COPY_GROUPS = Object.freeze([
  ...
  {
    ids: ["MaterialSubmission.storagePath", "MaterialSubmission.ragSourceId", "MaterialSubmission.ragDocId"],
    owner: "REQUESTING_USER",
