...
function materialProjection(row, file) {
  return {
    ...
    retentionClass: row.retentionClass || "DECISION_PENDING",
    retentionState: row.retentionState || "DECISION_PENDING",
    retentionPolicyVersion: row.retentionPolicyVersion || null,
    retentionDecision: row.retentionUntil ? "configured" : "decision_pending",
