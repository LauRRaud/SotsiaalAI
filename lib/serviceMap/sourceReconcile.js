...
import { SERVICE_MAP_VERIFIABLE_CONTACT_NAMESPACES } from "./contactFreshnessProjection.js";

const CONTACT_CHECK_LOCK_KEY = "service-map-contact-freshness-check";
const CONTACT_SOURCE_NAMESPACES = new Set(SERVICE_MAP_VERIFIABLE_CONTACT_NAMESPACES);
