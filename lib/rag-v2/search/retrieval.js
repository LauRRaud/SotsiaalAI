  ...
  try {
    ...
    async function hydrate(requested, suppliedBundles) {
      ...
      for (const bundle of bundles) {
        ...
        if (scope && stable(retrievalDirectory(bundle, generation.config.embedding)) !== stable(scope.byDocument.get(bundle.document.id))) fail('retrieval_directory_integrity_failed');
      }
