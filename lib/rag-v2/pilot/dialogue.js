...
import { dialogueStateEnabled, DIALOGUE_ANSWER_SCHEMA, STATE_INSTRUCTIONS } from './dialogue-state.js';

export const DIALOGUE_VERSION = 'm4-active-dialogue-1';
export const DIALOGUE_PROMPT_VERSION = 'm4-grounded-dialogue-5';
export const READABLE_DIALOGUE_PROMPT_VERSIONS = Object.freeze(['m4-grounded-dialogue-1', 'm4-grounded-dialogue-2', 'm4-grounded-dialogue-3', 'm4-grounded-dialogue-4', DIALOGUE_PROMPT_VERSION]);
export const DIALOGUE_SEARCH_VERSION = 'm4-user-scope-search-4';
export const READABLE_DIALOGUE_SEARCH_VERSIONS = Object.freeze(['m4-user-scope-search-1', 'm4-user-scope-search-2', 'm4-user-scope-search-3', DIALOGUE_SEARCH_VERSION]);
...
export function dialogueRequest(config, question, evidence, language, dialogue) {
  ...
  if (dialogueStateEnabled(config)) {
    body.text.format.schema = DIALOGUE_ANSWER_SCHEMA;
