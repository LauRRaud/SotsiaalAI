 ...
 *
 * AINULT `ACTIVE` VANEMJUHTUM (SOL-CW-03). Laud on TEGEVUSloend: READ_ONLY ja
 * ARCHIVED juhtumi mustandit ei saa enam muuta ega üle kanda (`withActiveCaseLock`
 * keeldub), seega tema kuvamine tegevusena lubaks tööd, mida kasutaja ei saa
 * lõpetada — loend ja kirjutusreegel ütleksid eri tõde. Sama filter on juba
 * kahel õel: `caseWorkMissingInfo.js` (lahtised punktid) ja `caseWorkAssist.js`
 * (järgmine kontakt). Arhiveeritud juhtumi mustand on endiselt loetav juhtumi
 * enda vaates, ta lihtsalt ei ole enam päevatöö.
 */
