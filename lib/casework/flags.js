 ...
 * õiguslik alus (leping Õ2/Õ3) on `LEGAL_ASSUMPTION`, mitte tõestatud fakt:
 * raamleping tõenäoliselt katab selle töötluse, aga andmekaitseanalüüs ei ole
 * seda kinnitanud. Ilma väravata tähendaks deploy automaatselt aktiveerimist —
 * ja „püsh ja deploy omaniku loal" EI OLE sama asi mis „õigusanalüüs on valmis".
 * Värav lahutab need kaks otsust teineteisest.
 *
