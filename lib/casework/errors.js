...
/**
 * Sama kasutaja liiga paljud samaaegsed päringud (SOL-CW-18).
 *
 * **429, mitte 503:** takistus ei ole teenuse seis, vaid kasutaja enda korduv
 * päring, ja 503 ütleks talle, et platvorm on maas. Ja **mitte 409**: seisund ei
 * ole vale, ta on ainult ajutine.
 */
export function tooManyRequests(messageKey = "casework.errors.too_many_requests") {
  return new CaseWorkError(429, messageKey);
}
