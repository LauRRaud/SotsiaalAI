 ...
 * (teenusekaart). Nemad hoiavad oma nurga-risti.
 *
...
export function panelDockRecedesAnywhere(normalized) {
  ...
  if (READING_ROUTES.includes(path)) return true;
  /* ADMIN käitub siin nagu lugemisleht (omanik 01.08: „kui ma kerin alla,
     siis peida ära see kiirmenüü, kasuta sama loogikat mis kasutusjuhendi
     lehel"). Põhjendus on sama, mis lugemislehtedel ja vastupidine sellele,
     miks mujal laual dokk püsib: admini aken EI OLE dokist kitsam — ta on
     täisekraan ja dokk seisab tema sisu peal. Alla kerides on ta ees,
     üles kerides ja põhja jõudes tuleb tagasi. */
