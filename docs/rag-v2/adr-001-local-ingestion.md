...
Parser töötab piiratud mälu ja ajaga worker'is. Edu korral lastakse worker'il koristamine lõpetada; seda ei lõpetata sunniviisiliselt kohe pärast sõnumit. Timeout lõpetab worker'i. PDF-i skripte, linke ja manuste tegevusi ei käivitata. Suuruse piirang kehtib enne parsimist; lisaks piiratakse lehti ja eraldatud teksti mahtu.
