...
- **runtime: not_run** — rakenduse päris loomisrada kahe samaaegse HTTP-päringuga sisselogitud brauserist läbi ei käidud; indeksi enda käitumine on tõendatud migratsiooniahela ja skeemi tasemel, teenuskihi tõlgendus fake-DB tasemel.
