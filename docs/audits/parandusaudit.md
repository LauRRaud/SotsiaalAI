...
Mõõdetud **12.08.2026** (üheksas mõõtmine, pärast SOL-PAY-04/-05); eelmised olid pärast
...
| | |
|---|---|
| Tehtud leidu | **138 / 403** selle tööpuu loenduri järgi · **138 / 429** kogu auditikorpuse peale — **26 leidu üheksas failis ei ole `main`-is**, vt „Auditikorpus ei ole ühes puus" allpool |
...
| Lahtised prioriteedi järgi | **P0-sid EI OLE** · 187 × P1 · 77 × P2 · 1 × P3 (selle puu loenduri järgi; kogu korpuses 291) |
...
| Maksed | SOL-PAY | 5/11 | 4 × P1 · 2 × P2 | käsil; PAY-09 ootab otsust, vt allpool |
