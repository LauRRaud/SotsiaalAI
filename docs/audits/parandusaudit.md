...
Mõõdetud **12.08.2026** (kaheteistkümnes mõõtmine, pärast SOL-PAY-10/-11); eelmised olid pärast
...
| | |
|---|---|
| Tehtud leidu | **143 / 403** selle tööpuu loenduri järgi · **143 / 429** kogu auditikorpuse peale — **26 leidu üheksas failis ei ole `main`-is**, vt „Auditikorpus ei ole ühes puus" allpool |
...
| Lahtised prioriteedi järgi | **P0-sid EI OLE** · 184 × P1 · 75 × P2 · 1 × P3 (selle puu loenduri järgi; kogu korpuses 286) |
