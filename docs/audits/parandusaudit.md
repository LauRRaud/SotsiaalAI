...
| | |
|---|---|
| Tehtud leidu | **150 / 403** selle tööpuu loenduri järgi · **150 / 429** kogu auditikorpuse peale — **26 leidu üheksas failis ei ole `main`-is**, vt „Auditikorpus ei ole ühes puus" allpool |
| Peatükke lõpuni | **12 / 39** — SOL-SCHEMA, SOL-BUILD, **SOL-AUTH**, SOL-RAGADMIN, SOL-FIELD, SOL-MEET, SOL-CHAT, **SOL-VOICE**, **SOL-ROOM**, **SOL-CALL**, **SOL-INV** |
| Lahtised prioriteedi järgi | **P0-sid EI OLE** · 181 × P1 · 71 × P2 · 1 × P3 (selle puu loenduri järgi; kogu korpuses 279) |
