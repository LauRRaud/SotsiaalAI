...
| M2 mitme allika järelkatse | Serveris ette valmistatud, pärisjooks käivitamata | 8 pärisallikat, 15 uut perekonda / 21 küsimust ja 9 regressiooniküsimust; 120-realine mock-mehaanika läbis kohalikult ja serveris tehnilise veata. Täpne uus embedding-manifest vajab omaniku luba. |
...
Mitme allika ettevalmistus lisas 4 testi ehk mõjutatud RAG-i lõplik komplekt on nüüd **61/0/0**. Lint, diff-kontroll, i18n ja tootmisbuild läbisid. Kood on GitHubis ja serveris; serveri kuivjooks kinnitas sama kaheksa allika manifesti, 69 indeksiüksust ja 120 tehnilise veata mock-meetodirida. Kasutaja käitus jäi suletuks.
...
Mitme allika järelkatse kood on serveris; kohalik ja serveri kuivjooks andsid sama manifesti `9526a80539a84e497226e48575ef1828f979c24dd3fcc41876c4909025e40592`. See taaskasutab 25 olemasolevat sisendit ning vajab kuni 73 uut embedding-katset, 23 554 sisendtokenit ja hinnanguliselt 0,003062020 USD. Järgmine samm on omaniku täpne luba, pärisjooks ja juhtumipõhine audit; alles selle tulemuse järel otsustatakse vajalik otsinguparandus või M4 piiratud ühendus. Esimese piloodi luba ei laiene nendele uutele sisenditele.
