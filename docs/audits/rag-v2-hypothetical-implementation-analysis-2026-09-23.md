...
**Opuse ülevaatuse järel 23.09:** omanik kinnitas peamiseks arendussuunaks RAG v2 / GraphRAG-i koos EstNLTK-ga päringu ja indeksi ühises kihis. [ADR-014](../rag-v2/adr-014-estnltk-retrieval.md) kirjeldab teostatud keelekihti; [ADR-015](../rag-v2/adr-015-opus-review-followup.md) KOV-i valekonfliktide ja piirkonnaandmete parandust, puhtamat vestluspäringut ning valikulist eelkontrolli. Need on kohalikud tehnilised parandused. Olukorrast ajakohase kontaktini jõudmine ja ajaperioodide süntees on jätkuvalt katmata tervikvõimed; hüpoteesi ei ole tervikuna tõestatud.
...
**23.09 täpsustus ja omaniku otsus:** EstNLTK/Vabamorf oli vana lahenduse Git-ajaloos juba olemas; eelnev hinnang käsitles seda ekslikult ainult võimaliku uue lisana. Vana vestlusrada kasutas analüsaatori `/analyze-query` liidest, eraldi lemmaindeks oli ainult võrdluskanal. Omanik soovis võtta üle keeleanalüüsi ning jätkata RAG v2 arendamist Opuse kriitikat arvestades. [ADR-014](../rag-v2/adr-014-estnltk-retrieval.md) kirjeldab nüüd teostatud ühist indeksi- ja päringukihti: EstNLTK/Vabamorf eesti vormidele, Snowball inglise/vene lisakanalile, muutumatu algtekst ja eraldi versioonitud põlvkond. Uute päringuplaanide vaikeprofiil on `hybrid-estnltk-dependencies-v1`. 25 näitlikku käändepaari ja läbiv kohalik otsing läbisid; see ei tõenda veel vestluse mõistmist ega kogu korpuse leidvust. Vana teenust ja käsitsi päringuheuristikaid ei taastata. Serverisse ühendamine ei ole selle kohaliku teostuse tõendiga tehtud.
