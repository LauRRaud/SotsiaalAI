...
6. **T21 P3 Meetodipeegel — JÄRGMINE kooditeema** (omaniku valik 19.07 õhtul: kõik otsused lukus O-CW-3-ga, üks uus mudel `PracticeReflection`, spec = alusdoki ptk 3).
