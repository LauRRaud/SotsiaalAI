...
| T21 | CASEWORK-V1 | **TÖÖS (tuum P0+P1)** | haru `codex/casework-v1`, baas `8eb3430b`; otsustevaba tuum = provenance-konsolideerimine (FIELD_PROVENANCE → jagatud `lib/workspaces/provenance.js`) + read-only adapterid + vastuvõtulaua ettevalmistuspaneel; P2–P6 (STAR2/Meetodipeegel/genogramm/ökokaart) VÄLJAS, vajavad O-CW/õigusanalüüsi |
