...
| T14 | WELLBEING-V2 | **LIVE** | E1+E2 tuum liidetud kohalikku `main`-i `8eb3430b` (merge `codex/wellbeing-v2 @ 981682c0`, baas `e0a78632`, omaniku loal 19.07), **LIVE serveris 19.07 (`ac0b7d3f`)**; kirjete lugemis-/kustutusrada + „Minu kirjed" naasmisvaade + V6 continuity + `wellbeing_space` adapter (SUPPORTED); 0 migratsiooni; **1736/1736 testi + väravad rohelised**; rütmikiht P2–P5 **AVATUD 19.07** (TO-1 = paranda uue kirjena, TO-2 = U1 sündmus + badge e-kirjata); org-koond endiselt VÄLJAS (O-WB-3 õigusanalüüs) — vt „Otsustering 19.07" + „T14 teostus 19.07" |
...
**Järgmine:** **T14 tuum liidetud kohalikku `main`-i 19.07 (`8eb3430b`, omaniku loal) — merge-luba antud; server/deploy jäävad eraldi otsuseks.** T14 rütmi-viil (P2–P5) on **19.07 otsusteringiga AVATUD** — TO-1 = „paranda uue kirjena" (versioonitus), TO-2 = U1 sündmus + badge, e-kirjata; vt „Otsustering 19.07". Järgmisena töösse võetud **T21 CASEWORK-V1 tuum** (P0+P1); vt „T21 teostus 19.07".
