...
6. ~~T21 P3 Meetodipeegel~~ — **`CODE_READY` 19.07 hilisõhtul** (`codex/casework-p3 @ 4908c636`, kõik väravad rohelised, ootab **merge/deploy luba**). Järgmised kandidaadid omaniku valikul: T21 P2 STAR2 (enne 2 lepingupunkti), T13 jätk (pausil), vahepalad (lint-võlg, A11Y-I18N-P0, RAG-QM-P0 baasjoon).
