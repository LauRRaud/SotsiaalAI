...
Kokku (20.07, T20+T03 deploy järel): **18 LIVE** (sh T20), 3 osaliselt (T03 mitte-häälne LIVE / hääl pargitud, T15, T18), 4 OOTEL (T08, T10, T13 pausil, T19), 2 ANALÜÜS (T25, T26), 1 värav (T27). Ajalooline (18.07): 13 LIVE, T20 alustamata. Harutasandi korrastus `lint-debt-cleanup` on main'is JA serveris.
