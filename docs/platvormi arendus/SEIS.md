...
| T14 | WELLBEING-V2 | **CODE_READY (tuum, harus)** | E1+E2 tuum valmis harus `codex/wellbeing-v2 @ 981682c0` (baas `e0a78632`), push'itud, EI main'is/serveris; kirjete lugemis-/kustutusrada + „Minu kirjed" naasmisvaade + V6 continuity + `wellbeing_space` adapter (SUPPORTED); 0 migratsiooni; **1736/1736 testi + väravad rohelised**; rütmikiht P2–P5 + org-koond VÄLJAS (TO-1/TO-2/O-WB-3) — vt „T14 teostus 19.07" |
...
**Järgmine:** omaniku valik {T22 (leping valmis, oli varem JÄRGMINE), T12, T21, T13} järgmiseks suureks teemaks; **T14 rütmi-viil (P2–P5) ootab eraldi lühikest otsusteringi (TO-1 kirje elutsükkel, TO-2 kontrollpunkt+meeldetuletus).** Merge-luba T14 harule = omaniku otsus.
