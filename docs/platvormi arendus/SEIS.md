...
Kokku (20.07, T20 järel): **17 LIVE**, 1 `CODE_READY` ootab merge-luba (T20; ka T03 on main'is aga serverisse deploy'mata), 2 osaliselt (T15, T18), 4 OOTEL (T08, T10, T13 pausil, T19), 2 ANALÜÜS (T25, T26), 1 värav (T27). Ajalooline (18.07): 13 LIVE, T20 alustamata. Harutasandi korrastus `lint-debt-cleanup` on main'is JA serveris.
