...
| **T14** WELLBEING-V2 | `t14-wellbeing-v2-ulesanne.md` + `t14-wellbeing-v2-kontrollpunkt-ulesanne.md` | E1–E2 tuum main'is ✓; **WB-V2-P2 kontrollpunkt CODE_READY** (`codex/wellbeing-kontrollpunkt @ d3b802a5`, vt „T14 teine viil 19.07") | E0 LIVE ✓ + K1-P0 main'is ✓ | P3 (O-WB-1/O-WB-5/O-WB-2a), P4 (TO-8), P5 (TO-3/4/5/7/9) |
