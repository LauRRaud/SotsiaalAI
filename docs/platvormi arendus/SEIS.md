...
| T21 | CASEWORK-V1 | **MAIN (tuum liidetud)** | liidetud kohalikku `main`-i `d27066c2` (merge `codex/casework-v1 @ 73c3953e`, baas `ae997dbd`, omaniku loal 19.07), haru push'itud origin'i; EI serveris; otsustevaba tuum = provenance-konsolideerimine (FIELD_PROVENANCE → jagatud `lib/workspaces/provenance.js`, FIELD-regressioon roheline) + read-only adapterid + vastuvõtulaua ettevalmistuspaneel; 0 migratsiooni; **1743/1743 testi + väravad rohelised**; P2–P6 (STAR2/Meetodipeegel/genogramm/ökokaart) VÄLJAS, vajavad O-CW + O-CW-7 õigusanalüüsi |
...
**Järgmine:** T21 P2/P3 avanevad lühikese otsusteringi järel (O-CW-2/3/4/10); P4/P5 vajavad O-CW-7 õigusabi (ei alustata koodiga). Omaniku valik järgmiseks suureks teemaks {T22, T12, T13}. **Push + merge TEHTUD omaniku loal** (`main @ d27066c2`, `origin/codex/casework-v1 @ 73c3953e`); server/deploy = eraldi otsus (kohalik `main` on `origin/main`-ist ja serverist ees).
