...
| T12 | ROOMS-CALLS-V1 | **TÖÖS — E1–E3 harus valmis** | 19.07 alustatud, worktree `../SotsiaalAI-rooms-calls-v1`, haru `codex/rooms-calls-v1`, baas `d5d16a2e`. **E2** race-migratsioon (`20260721000000_rooms_calls_v1`, 2 partial-unique indeksit — 3. oli juba olemas, audit eksis) + P2002-katted (`a6811ed2`); **E1** elutsükli ristkoristus (jagatud helper, ruumi-DELETE lõpetab kõned + audit, leave vabastab osaluse+consent) (`cc02417a`); **E3** GET-püünised + rate-limit ette + IP eemaldatud + pikkuspiirid + `statusForCallError` maskimine + 4 i18n-võtit (`f20b9fc4`). 60/60 testi + lint 0 + i18n OK. **JÄÄB E4** (kutse/kustutuspoliitika/omanikuvahetus + `archivedAt`), **E5+E6** (salvestuse nõusolek+egress+retention — suurim, `RECORDING_ENABLED` värav), **E7** (kokkuvõtte kandja). main/server/merge/deploy PUUTUMATA. E1 kliendipool (14 K1 näovahetus) veel tegemata. |
