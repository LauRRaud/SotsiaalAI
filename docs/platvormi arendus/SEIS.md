...
5. ~~T12 ROOMS-CALLS-V1~~ — **E1–E7 VALMIS 19.07** (`CODE_READY`, haru `codex/rooms-calls-v1 @ 821f4da5`); DoD täidetud, ootab **merge/deploy luba**. Alles: E1 kliendipool (14 K1 näovahetus) + `RECORDING_ENABLED=true` (T27).
6. **T13 COVISION-V2** — **JÄRGMINE kooditeema** (prototüüp-esimene: Faas A = kohustuslik värav, Faas B avaneb ainult prototüübi vastuvõtu järel); **T10 PUBLIC-V1 + release-rada (D)** nihkub plokki „siis, kui omanik tahab turule".
