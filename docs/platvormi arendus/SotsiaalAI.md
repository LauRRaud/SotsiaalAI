...
**Aardvarki SOL-HELP-10 järelparandus sulges spoofitava IP-päisega kvoodist möödumise.**
Autenditud abi- ja aadressiotsingu kvoot põhineb nüüd kasutajal ning toimingul, aegunud bucketid
koristatakse inline ja vigane kuulutuseliik ei kirjuta limiterisse. Järgmine tööots valitakse S4-st.
