...
**Deploy' sõltuvuste paigalduse turvapiir on parandatud.** `npm ci` jookseb nüüd enne tootmise
keskkonna eksportimist, nii et sõltuvuste lifecycle-skriptid ei päri andmebaasi-, auth'i ega
teenusevõtmeid; järjekorda lukustab regressioonitest. Järgmine tööots valitakse S4-st.
