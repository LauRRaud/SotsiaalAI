...
**P0/F04/F05 ja F06 on main'i integreeritud; repair-a harus on nüüd F07 autor+teema kinnitus ja serveriga seotud teosevalik.** Kasutaja saab valida „teine”, täpse pealkirja või „mõlemad”; kahe teose vastused ja tõendid kontrollitakse eraldi ning aegunud või muutunud valik nõuab uut pakkumist. [F07 valikuleping ja piirid](../audits/rag-susteem-master.md#1310-vestlusega-seotud-teosevalik--f07-teine-kohalik-plokk), [kontrollitõendid](../../eval/rag-uus75-kontroll-2026-08-31.md). Järgmisena: F07 eraldi loendusühikud ja F08 järjekorraseosed; enne serveriväiteid lubatud integratsioon, katsete migratsiooni kontroll ning autenditud valiku-/allikapaneeli-/diagnostikarada. F07 pole main'i integreeritud; serveripaigaldust ega migratsiooni selles plokis ei tehtud. Pärisvestlus ja produktsioonivalmidus jäävad `NOT_PROVEN`.
