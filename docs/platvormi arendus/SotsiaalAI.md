...
**Aardvarki eelpöördumise kiiruspiiri leid on parandatud.** Jagatud IP-põhine väärkasutuspiir
ei usalda enam kliendi muudetavaid edastuspäiseid, vaid ainult seadistatud usaldatud proxy
päist; ilma selle seadistuseta jääb kehtima kasutajapõhine piir.
