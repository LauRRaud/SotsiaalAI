...
**Lapse heaolu allikaseose parandus on serveris, kuid uus paariskordus jäi 0 PASS / 2 PARTIAL / 0 FAIL.** Kolm järjestikust eelküsimust olid PASS; üks ekslikult vanasse vestlusse saadetud M01 on eraldi logitud ja hindest väljas. Mõlemas sihtvastuses olid õiged RAG-tekstid olemas, kuid jaotise pealkirjad hoiavad alles liigse taustaallika ning mudeliallika seos sõltub endiselt sõnajärjest ja „märgid/märkide” vormist. [Täisvastused, paneelid ja põhjuse tõend](../../eval/luna-retest-progress.md). Järgmine töö on struktuurse pealkirja/väite eristus ning allikapõhine nimelise mudeli identiteet, omaniku uue korralduse alusel. Uut parandus- ega küsimisringi ei käivitatud; kogu75/37 ja10/10 on tõendamata. Ajastatud automaatjätk PAUSED.
