...
**07.09 siht on kogu töötav ja müüdav GraphRAG-toode, mida kasutatakse ja katsetatakse SotsiaalAI-s; ühine loogika peab sobima eri valdkondadele ja kliendispetsiifiline sisu on kohandatav.** Ühe dokumendi teadmismustandi koostamise, haldaja valiku, uue versiooni ja indeksi päriskontroll läbis: 13 väidet ning üks alles jäetud seos jõudsid andmebaasi ja allikaviidetega otsingukonteksti. Ühe lubatud mudelipäringu limiit on kasutatud; avaldamine kasutas olemasolevaid vektoreid. Tootmisvastuse allikad jäävad eraldi paneeli, sõnumimullis viitemärke ei kuvata. Järgmine arendusplokk on korpuse jätkatav mahutöötlus, seejärel teekaardi ülejäänud M1–M6 võimed. Etappide seis on S2 RAG-lõigus; [koostamise leping ja tõend](../rag-v2/adr-008-source-knowledge-preparation.md).
...
1. **Korpuse maht ja käitamine:** päringusse ainult vajalikud indeksiüksused ja sõltuvused, mitte kogu korpuse korduv valideerimine/laadimine. Suurte importide osadeks jagamine ja jätkamine tuleb teha enne praeguse 5000 tekstiosa piiri muutmist. Versioonitud paigaldus/uuendus, õiguste eraldatus, taastamine ja kuluarvestus peavad toetama kogu toote kasutamist.
