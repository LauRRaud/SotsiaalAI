...
**P0/F04/F05 ja F06 kohalik paranduste pakett on main'i integreeritud ning sihtkontrollid läbivad; serveris paketti veel pole.** Jaotus, täielik liikmeloetelu ja põhjendatud osavastus säilitavad sama tõendi ning kuvatava allika. Järgmine aktiivne töö on F07 autori ja sõltumatu sisuteema põhine teosevalik, seejärel loendusühikud ja F08 järjekorraseosed. [Teostus ja piirid](../audits/rag-susteem-master.md#138-jaotus-liikmeloetelu-ja-toetatud-osavastus--kohalik-f06-plokk), [kontrollitõendid](../../eval/rag-uus75-kontroll-2026-08-31.md). Autenditud kohaliku kontrolli eelduseks olev `RagAttempt` tabel puudub; migratsiooni ega deploy luba selles sammus ei kasutatud. Pärisvestlus, serverivastus ja produktsioonivalmidus jäävad `NOT_PROVEN`.
