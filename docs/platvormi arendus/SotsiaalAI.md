...
**07.09 siht on kogu töötav ja müüdav GraphRAG-toode, mida kasutatakse ja katsetatakse SotsiaalAI-s; ühine loogika peab sobima eri valdkondadele ja kliendispetsiifiline sisu on kohandatav.** M3 uues arendusplokis saab haldaja koostada dokumendist allikakohtadega väite-/seosemustandi ning salvestada valiku uue versioonina; lahendamata sõltuvused säilivad ka otsingukontekstis. Kood ja tehnilised sihttestid on valmis, lõpuvärav ning päris DB/UI/mudeli kontroll pooleli. Jätkame selle tervikahela kontrollist, seejärel suure korpuse jätkatava töötluse ja teekaardi ülejäänud võimetega. Etappide seis on S2 RAG-lõigus; [koostamise leping ja tõend](../rag-v2/adr-008-source-knowledge-preparation.md).
