...
**31.08 RAG-diagnostika v2 ja automaataruanne on `main`-is ja serveris; F02 täpne tagasilükkamise põhjus on nüüd in-app aruandest loetav.** Esimene plokk — kolm põhiküsimust eraldi ja järjest — andis 3 PASS / 1 PARTIAL / 2 FAIL. Omaniku nõutud jäljetäiendus näitas järelpäringus valesti nõutud 2019/2022, artikli tegeliku aasta 2023, sobinud autori ja ajaloo teadliku 6→0 väljajätmise. [Testitõendid](../../eval/rag-uus75-kontroll-2026-08-31.md), [leping ja piirid](../audits/rag-susteem-master.md#135-vastuse-diagnostika-ja-automaatne-vestlusaruanne). Järgmine eraldi parandatav põhjus on aastarollide segiajamine; selles plokis vastamise reeglit ei muudetud. Kogu75/37 ei ole tõendatud ning automaatkontroll ei garanteeri sisulist õigsust ega alati algpõhjust.
