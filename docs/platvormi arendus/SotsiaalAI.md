...
**07.09 M4 tõendiga seotud mustandi kohalik katsekandidaat on valmis ja vaikimisi väljas.** Sama vastamiskutse võib siduda allikaploki täpse algtekstiväljavõttega; v3 baasrada ja nähtav kuju säilivad. 56 sihttesti, tegelik brauseritaastus/allikavaade ning lint/i18n/build läbisid, välismudelikutseid, push'i ja deploy'd ei tehtud. [Kohalik raport](../audits/rag-v2-evidence-draft-local-2026-09-07.md) eristab allikaseose kontrolli semantilisest toest: ehtne tsitaat ei tõenda parafraasi. Ette on valmistatud veel kinnitamata 7 + 7 vastamiskatse võrdlusplaan kolme teadaoleva ja nelja uue fikseeritud küsimusega; sisuline kasu on NOT_PROVEN. Järgmine otsus on piiratud võrdluse luba või kandidaadi kõrvalejätmine, seejärel eraldi jätkuvestluse arendus. V3 nelja juhtumi avaldamisparandus jääb lõpetatuks, M4 avalik vastuvõtt lahtiseks; senised ledgeri piirid, algandmete loa lõpp 07.09 kell 08:00 UTC, M2/M2.3 kinnitused ja seitse lahtist juhtumit säilivad.
