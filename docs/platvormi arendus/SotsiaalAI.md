...
**20.09 mobiili kaardiakende laiused ja sisu — serveris (`174237b4`).** Hinnastuse kaardid paiknevad madalamal. Sisu moodustab tasakaalustatud terviku: paketinimi, hind ja kirjeldus on eraldi vahedega ning nupp ja link paiknevad eeliste järel piiratud vahega. Sama paigutus mobiilis ja desktopis, seniste seadmekohaste kaardimõõtudega. Pikk sisu kerib kaardi sees. Brauseri kontroll omaniku soovil `not_run`.
...
**Hinnastuse mobiilimõõdud ja sisupaigutus (20.09, serveris `174237b4`).** Kaartide pealkiri, hind, kirjeldus, eelised ja tegevused on ühtse vahedega kompositsioonina nii mobiilis kui desktopis. Nupp ja link jäävad eeliste lähedale; pikk sisu kerib algusest. Kaardid paiknevad madalamal ning säilitavad seadmekohased mõõdud. Visuaalne runtime `NOT_PROVEN` — omanik testib ise.
