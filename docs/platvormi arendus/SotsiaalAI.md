...
**Aardvarki andmekoopia-kustutuse leid on parandatud.** Konto kustutus eemaldab andmekoopia
ZIP-id enne tööde kaskaadi ja jääb failiveal pooleli; samal ajal lõpetav worker kustutab ZIP-i,
kui tema READY-üleminek kaotab konto kustutusele. Järgmine tööots valitakse S4-st.
