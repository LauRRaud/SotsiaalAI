...
**Aardvarki SOL-CALL-06 järelleid on parandatud.** Pooleli kustutatav või karantiinis
kõnesalvestis ei ilmu enam dokumentide ega heliallikate loendisse ning tema detaili,
allalaadimist, valimist või transkribeerimist ei väljastata. Järgmine tööots valitakse S4-st.
