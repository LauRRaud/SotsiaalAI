...
**05.09 M2.3 rubriigi versiooni `2.0-proposal-2` täpsustused on omaniku käsul GitHubis; inimülevaatus on ootel.** Neli allikapõhiselt kontrollitud täpsustust säilitavad soovitusliku/tingimusliku tähenduse, lubavad 20 toetatud projekti arvule piisava alternatiivi, lisavad tööandja lk 3 osalise toe ja märgistavad EKA seotud loo eelvaate. 15 perekonna 29 nõuet ning 37 tõenduskomplekti rakendati samale 84 reale võrguta; v1 tekstid, järjekord, tokenid ja hinnangud säilisid. [Uues privaatses paketis](../../tmp/rag-v2-m2-3/rubric-v2-proposal-2/review.html) on 75 konteksti ja 142 ootel otsust; inimese kinnitusi pole ning lõpphinnangud jäävad `needs_review`. Järgmine samm on tegelikud sisulised kinnitused, seejärel sama tulemuse lõplik kordushindamine enne ühe otsinguparanduse valimist. Kümme sihttesti, lint ja build koos i18n-ga läbisid; [audit](../audits/rag-v2-multi-source-preparation-2026-09-05.md) säilitab mõlemad rubriigiversioonid ja tõendid. Otsingut, andmebaase ega serverit ei muudetud; uusi väliskutseid ega deploy'd ei tehtud. Privaatsed raportid ja otsusefailid jäid kohalikuks. Luna/M3/M4 on ulatusest väljas.
