...
**RAG-i semantiliste lepingute diagnostiline release `77a30a3d` on 26.08 toodangus; kogu süsteem on endiselt PARTIAL.** Shadow-v2 säilitab planneri aastarollid ja arvuslotid provenance'iga trace'is, kuid ei otsusta tootmises. Renderdatud tõendist tuletatud `requested_metric_contract` lubab J08 generaatoril kasutada ainult nelja küsitud protsendislotti ning kitsas `numeric_relation_contract` säilitab J18 osalejarühma ja koguarvu seose; validator jäi fail-closed ja FAIL-i korral on `displayed_sources=[]`. Pärast täielikku kordusdeploy'd läbisid samas autentitud vestluses J08 A/B väärtustega 61/26/11/18, J18 A/B väärtustega 5/5/5 ja 15 ning J07 väärtustega 678/273/21 600/12/43 vastuse, trace'i ja ühe toetava hover-allikakaardi värava. J07 ja J08 on aktiivsel release'il **DONE**, J18 **PARTIAL** ainult seetõttu, et virtualiseeritud vestluse brauseriaeg jäi tabamata; range aktiivse SHA vaade on **DONE 2/75 · PARTIAL 1/75 · NOT_PROVEN 72/75**. Ajalooline koond jääb **DONE 21/75 · NOT_PROVEN 54/75**. Järgmine töö on temporal typed-semantics'i `artikkel`/aastarolli juurpõhjus, author/year/history precedence ning legal/KOV ja atribuutika sentinelid; enne nende mõõtmist ei promote'ita temporal välju ega nimetata release'i FINAL_SHA-ks.
