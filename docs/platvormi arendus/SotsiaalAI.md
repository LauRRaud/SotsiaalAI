...
**Teenuspäeviku päevateekonna kaardi salvestatud XSS on suletud.** Leafleti hüpik ei saa enam
kliendi nime ega aadressi HTML-ina tõlgendada: kasutajasisu lisatakse DOM-i ainult tekstina.
...
Päevateekonna kaardi hüpik käsitleb kliendi nime ja aadressi tekstina, mitte käivitatava HTML-ina.
