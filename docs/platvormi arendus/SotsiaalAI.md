...
**07.09 M4 7+7 pärisvõrdlus tehtud: tõendimustandi kandidaat jääb välja.** V3 baas avaldas 7/7 vastust, kandidaat 0/7, sest mudeli tsitaadid ei vastanud täpselt algtekstile. Serverisse paigaldatud tähtajata toe järel eemaldati ka 20 varasema M4 kirje ja kolme vestluse tähtajad; sisu ja kululoendurid säilisid. [Pärisvõrdluse raport](../audits/rag-v2-evidence-draft-local-2026-09-07.md) sisaldab tulemusi ning kulusid. Server on tagasi baasvariandil ja mõlema haru kvoot täis. Järgmine töö on eraldi otsus tõendiseose uue lahenduse või jätkuvestluse arenduse kohta. Baasi sisuline kvaliteet ja M4 avalik vastuvõtt on endiselt lahtised; M2/M2.3 kinnitused ning seitse lahtist juhtumit säilivad.
