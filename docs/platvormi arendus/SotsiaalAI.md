...
tekstotsingu lisakanal on teostatud. Kuue allika / 73 tekstiosa kohalik vastuvõtu-
ja otsingurada läbis; päris AI-kutseid 0. Vastuse olukorrapõhist üldjuhist täiendati
sama ühe vastusekutse sees. [ADR-011](../rag-v2/adr-011-resumable-intake-and-language-search.md)
eristab läbitud sihtteste, kolme vana artiklitesti lahknevust ja allesjäänud piire.
Omaniku 23.09 täpsustusega on tasulise testiringi nõue eemaldatud; arendus jätkub
kohalike sihtkontrollidega. Jätkuplokis valmis allikate ülevaatuse ja partii
avaldamise kohalik API/CLI; 41 sihttesti läbisid, sh avaldamisest otsinguni
koos õiguste ja allikaviidetega. Valmis on ka püsiva edenemisseisuga kohalik
indekseerija, mis jätkab väikeste portsjonitena ja aktiveerib kontrollitud terviku;
42 sihttesti läbisid ([ADR-012](../rag-v2/adr-012-resumable-indexing.md)).
Senine RAG-plokk on kohalikus commit’is `22193e7a`. Jätkuplokis valmis
otsingu valikuline dokumendilaadimine koos seotud erandite/tingimustega;
50 eri sihttesti läbisid ([ADR-013](../rag-v2/adr-013-selective-retrieval.md)).
Edasi tuleb teadmiste ja puuduvate vektorite mahutöö ning adminiliidese ühendus. Kogu korpuse töötlus,
...
**20.09 mobiili kaardiakende laiused ja sisu — serveris (`39c7750b`).** Hinnastuse kaardid paiknevad madalamal. Sisu moodustab tasakaalustatud terviku: paketinimi, hind ja kirjeldus on eraldi vahedega ning nupp ja link paiknevad eeliste järel piiratud vahega. Sama paigutus mobiilis ja desktopis, seniste seadmekohaste kaardimõõtudega. Pikk sisu kerib kaardi sees. Omaniku uuendatud juhis: nende UI-paranduste järel kohe serverisse, eraldi teste ja kohalikku build’i ei käivitata; serveri vajalik build jääb juurutusse. Visuaalne kontroll `not_run`, omanik testib ise.
...
sisureserv ja modaali sisuala arvestavad tõstetud dokki. Rõhtvaade säilib.
Telefoni visuaali kontrollib omanik; runtime not_run.
...
peidetud kaardid ei hoia enam renderdamiseks nähtavaid klaasikihte.
Brauseri ja telefoni kontroll jääb omaniku soovil talle (NOT_PROVEN).
...
14 px taustahägu. Nupu Sisenen hover ei kirjuta enam mobiili tähevahet üle.
Chromiumi puutesisend, hägu visuaalne võrdlus, lint, i18n ja build läbisid.
Avalikus HTML-is ja DOM-is üks `black` olekuriba määrang; Sisenen-puutekatse
läbis ka tootmises. Serveri tööpuu puhas, frontend aktiivne, HTTP/HTTPS 200.
...
ning sama sisemist helki avatud ja suletud olekus. Päris iOS: NOT_PROVEN.
...
hammasratta joon skaleerub nüüd teiste ikoonidega võrdselt. Madalas mobiili
...
Mobiilimenüü arvestab ekraani pööramise ja dünaamilise kõrgusega: ülariba
avaneb vajutusega, kiirmenüü paikneb kaartidest allpool ning horisontaalne
svaip ei liiguta lehte püsti. PWA iOS-i olekuriba kasutab musta tausta.
Kinnituslehe teated mahuvad ekraanile; sessioonita jätkunupp juhatab tagasi
PIN-i sisestamise aknasse ja algne aken kontrollib kinnitust naasmisel.

Karusselli esmane viivitus säilib, külgsuunas kerimine ei käivita saabumist
uuesti. Ligipääsetavuse dokis on aktiivse punkti kõrval lühinimi ja hoveril
täisnimega infomull. Kiirmenüü mõõdetud nupulaiused muutuvad koos 320 ms jooksul;
taust ja serv vahetuvad kohe, et vana valik ei jääks hajuma. Jaamade naaberlend
kestab umbes 0,61 sekundit ning hajumise otsad on pehmed. Vähendatud liikumise
korral kiirmenüü ei animeeri laiust ja jaamadel säilib lame ristsulandus.

Kohalikud brauserikontrollid hõlmavad puute- ja rõhtvaadet, lõpunuppu,
...
**Kasutuseesmärk (omaniku täpsustus 23.09).** Üks väga hea süsteem peab leidma ajakirjadest teadmisi, aitama uurida teemasid ja seoseid eri ajaperioodidel ning leidma õige KOV-i toetused, teenused ja kontaktisikud. Kõik kolm kuuluvad sama toote sihti. [Täiendatud hüpoteetiline analüüs](../audits/rag-v2-hypothetical-implementation-analysis-2026-09-23.md) pakub ühist allika-/õiguste-/tõendituuma, küsimuse järgi valitavaid päringuviise, struktureeritud kohalikke kirjeid ja ajakohasuse kontrolli ning kõiki kolme eesmärki katvat esimest valimit. Kasutuseesmärk on kinnitatud. Omaniku järgneval loal algas 23.09 kohalik teostus; esimese ploki ulatus ja tõend on ADR-011-s. Ülejäänud tehnilised ettepanekud on jätkuvalt arendusplaan.

**Vestluslik kasutuskogemus (omaniku täpsustus 23.09).** RAG-i kasutamine peab tunduma vestlusena assistendiga: kasutaja räägib oma sõnadega, assistent hoiab asjakohast konteksti, mõistab jätkuküsimusi ja parandusi ning küsib ainult vajalikud täpsustused. Otsinguviisi valimine ja tõendi hankimine toimuvad taustal. Vastus annab selgituse ja sobiva järgmise sammu; allikad jäävad avatavaks olemasolevas allikapaneelis. Analüüsi §8.1 ja vastuvõtukriteeriumid kirjeldavad ka tõendi taaskasutust, uut otsingut vajavaid pöördeid ning tervete vestlusjadade kontrolli. Nõue on kinnitatud. 23.09 lisati olemasolevasse vastusekutsesse olukorra tõlgendamise ja vajalike täpsustuste üldjuhised; sisuline pärismudeli vastuvõtt on veel NOT_PROVEN.

**Allikate tootmisvaade (omanik 07.09).** Vastuse sõnumimulli tekstis viitemärke ei kuvata. Allikad avanevad eraldi „Vastuste allikad” paneelis: autor, aasta, pealkiri, väljaanne, leheküljed ning allikaveast teatamise võimalus, vastavalt omaniku näidatud olemasolevale vaatele. Väite ja allika seos säilib süsteemi andmetes; eraldi test-/pilootvaates võivad tekstisisesed viitemärgid tõendamise jaoks alles jääda.
...
**RAG v2 arenduse koht 08.09.** [Arendusteekaart](../SOTSIAALAI_RAG_GRAPH_ARENDUSTEEKAART_v0_1.md) määrab suuna; selle 05.09 seisu kirjeldavad lõigud on ajaloolised. Käesolev seis lähtub teostusest ja viimase serverikatse tulemusest.

| Etapp | Tegelik seis |
| --- | --- |
| M1: dokumendi ettevalmistus | Kohalik PDF/HTML/XML/JSON-i sisendiplokk on 08.09 kontrollitud seitsme pärisallikaga: muutumatud algfailid, struktuursed plokid, täpsed allikakohad ja metaandmete päritolu. Toetatud on tekstikihiga üheveeruline PDF ning püsiva vahega kaks veergu. OCR, keerukad paigutused ja kogu korpuse vastuvõtt on lahti. Admini vastuvõtt on endiselt PDF-i jaoks. Nelja vormingu kohalik päris indeks testvektoritega ja eraldi autenditud testadapteri brauserirada on kontrollitud; tootmise pärismudelirada on NOT_PROVEN. |
...
| M3: sisuline sõltuvuskiht | **Osaliselt teostatud.** Ankurdatud väited/sõltuvused, indeksiobjektid, piiratud graafiotsing ning haldaja teadmismustandi koostamise ja valiku voog on serveris. Ühe dokumendi päris Luna → brauseri läbivaatus → muutumatu versioon → PostgreSQL/Qdrant avaldamine → leksikaalse otsingu sõltuvuskontekst läbis; alles jäi 13 väidet ja üks `QUALIFIES` seos. Kandidaadid jäävad kontrollimata otsinguabiks. Mitme dokumendi automaatne seostamine, sisuline kinnitamine, kasutajafaktide/ajapiiride sidumine ja mahuka koostamise jätkamine on lahti. Lahendamata sõltuvuste tee on kaetud sihttestiga, selles pärisdokumendis lünki ei tekkinud. [Algne sõltuvusleping](../rag-v2/adr-007-source-dependencies.md), [Koostamise leping ja tõend](../rag-v2/adr-008-source-knowledge-preparation.md). |
...
### M1 sisendiploki kohalik vastuvõtt — 08.09.2026

[ADR-010](../rag-v2/adr-010-source-structure-and-chunking.md) sisendiplokk on kohalikus main-tööpuus teostatud ja valimi ulatuses vastu võetud. Algfailide korrastust ei korratud; failiregister ja arhiiv säilivad. Ühine tuum säilitab nelja vormingu algfailid, muutumatud versioonid, täpsed tekstivahemikud ning bibliograafia/kehtivuse/kogumisaja eraldi päritolu. PDF-i veerud ja lõigud, HTML-i sisu, XML-i õigusnormid ning JSON-i teenuse-/kontaktikirjete piirid jõuavad tekstiosadesse. Allikakohad säilivad teadmiskirjetes, otsingu kanoonilistes viidetes, M4 taastamisrajas ja ekspordis; tüübid on täiendatud ning varasem PDF-kuju jääb loetavaks.

Seitsme pärisallika vastuvõtu, sihttestide ja lõppvärava üksikasjad ning räsidega mõõtmistulemus on [ADR-010 vastuvõtulõigus](../rag-v2/adr-010-source-structure-and-chunking.md#kohalik-vastuvõtt-08092026). Lint, tüübikontroll, tõlkekontroll, diff-kontroll ja tootmisbuild läbisid. Toetatud PDF-paigutus ei kata OCR-i, keerukaid tabeleid, joonealuste märkuste täielikku eraldamist ega kõiki ajakirjakujundusi. KOV-/organisatsioonitekst on varem kogutud paketi sisu koos päritoluga; see ei ole värskelt kontrollitud veebitsitaat. Vastuolulised metaandmed säilivad kandidaatide ja hoiatustena läbivaatuseks.

**Järgnenud ühendus- ja väljalaskeplokk 08.09:** [raport](../audits/rag-v2-release-integration-2026-09-08.md) tõendab 4 dokumendi / 52 tekstiosa kohalikku PostgreSQL/Qdranti rada testvektoritega, ajaloolise viite säilimist, katkestust ja hooldus-rollback'i. Eraldi fikseeritud M4 testadapteriga läbiti kõigi nelja vormingu autenditud allikavaade ja vestluse taastamine ning HTML-allika õiguse eemaldamine. Need ei tõenda üht pärismudeli tootmispäringut. F02 dokumendiloa korduskontroll ja F01 brauseri/serveri piir on parandatud; kood on kohalikus commit'is `ad44c302e`, lint/i18n ja mõlemad build'id läbisid. Serveri 08.09 lugemiskontroll kinnitas aktiivse indeksi ning M4 põlvkonna lahknevust ja adminiseadistuse aegumist. Kontrollitud väljalase vajab omaniku luba ning uut kooskõlalist M4 plaani. Admini vastuvõtt on endiselt PDF-i jaoks; kogu korpuse ingest ja tasuline mahutöötlus pole alanud.

**23.09 hüpoteetiline teostusanalüüs — teine läbivaatus:** [Opusele mõeldud analüüs](../audits/rag-v2-hypothetical-implementation-analysis-2026-09-23.md) seob varasema mahutöötluse ja käitamise plaani omaniku kolme kasutuseesmärgiga. Lisatud on teenuse/toetuse/kontaktrolli identiteedid, väljade päritolu ja värskus, perioodide katvus, eri päringuviisid ning kasutusjuhtude vastuvõtukriteeriumid. Esimese valimi ettepanek hõlmab kõiki kolme rada; ajaline võimekus ei jää ainult tootestamisejärgseks lisaks. Analüüsi esialgsele koostamisele järgnes omaniku arendusluba. Lisatud §8.3–8.5 käsitlevad keelt, olukorrapõhist abi ja mudelikulu. Kohaliku teostuse ulatus on allpool; serveri praegust seisu selle tööga ei mõõdetud. Omaniku järgneval soovil täiendati analüüsi §12 Opuse sõltumatu arhitektuuri- ja koodiülevaatuse ülesandega: kasutuseesmärk, kolm arenduscommit'i, hüpoteesi kontrollküsimused, tõendi piirid ning oodatud leiud ja järgmiste plokkide põhjendus. Ülevaatus ise ei ole selle teksti koostamisega tehtud.

**23.09 esimene töötav kohalik plokk:** [ADR-011](../rag-v2/adr-011-resumable-intake-and-language-search.md) ja [räsiga koondtõend](../rag-v2/adr-011-local-evidence.json) katavad püsiva partiinimekirja, üksikallika tööõiguse, katkestusest jätkamise, muutumatu väljundi kontrolli ning tekstiosa/tokeni mõõtmise. Kuus allikat neljas vormingus andsid 73 tekstiosa / 28405 embedding'u sisendtokenit; piiratud jooks jätkus uues protsessis. Partiitöö ei avalda automaatselt. Valim avaldati hiljem ainult isoleeritud kohalikus testtenant'is ja indekseeriti testvektoritega. Uus `pg-snowball311-et-en-ru-v1` tekstikanal ja `hybrid-multilingual-dependencies-v1` profiil säilitavad algteksti ning vana indeksilepingu. Kolm leksikaalset päringut leidsid täpsete allikakohtadega tulemused, mudelikutseid 0.

Uued partii/keeletöötluse kontrollid ja olemasoleva vestluse 38 isoleeritud andmebaasitesti läbisid. Kolm laiemat vana artiklitesti ei klapi ajaloolise sisendi eeldustega; sama lahknevus kordus varasema vastuvõtukoodiga (ADR-is täpsustatud). Uus olukorrapõhine vastusejuhis ei lisa mudelietappi, kuid pärismudeli sisuline kvaliteet on veel tõendamata. Tüvestaja ei ühenda kõiki eesti käändeid; mitmekeelne tähendusotsing jääb vajalikuks. Omaniku 23.09 täpsustusega eemaldati kavandatud tasuline testiring nõuetest; arendus ei oota selle luba. AGENTS.md suunab antud arendusloa piires iseseisvalt edasi töötama ja kasutama vajalikke kohalikke kontrolle. Tasulisi kutseid pole tehtud. Üldine värske KOV/kontakti vastuvõtt, semantiliste seoste mahttöö, kogu korpuse käitamine ja ajaline süntees on lahti.

**23.09 partii ülevaatus ja avaldamine:** kohalik `review`/`publish` API ja CLI seovad otsused konkreetsete allikaversioonide, hoiatuste ning kataloogipõlvkonnaga. Konfliktse allika saab põhjendusega välja jätta; seda ei saa märkusega õigeks kinnitada. Valitud allikad avaldatakse korraga ja sama otsuse kordamine ei kirjuta uuemat põlvkonda üle. 41 sihttesti läbisid, sh päris kohalik PostgreSQL/Qdranti rada avaldamisest käändevormi tekstotsinguni koos õiguste ja allikakohtadega. Mudelikutseid 0. [ADR-011 jätkuplokk](../rag-v2/adr-011-resumable-intake-and-language-search.md#partii-ülevaatus-ja-avaldamine--2309-jätkuplokk) kirjeldab kasutamist ja piire: adminiliides, indeksi automaatne aktiveerimine ja protsessi sundlõpetamise järel allesjäänud kirjutusluku taastamine on veel tegemata.

**23.09 jätkatav indekseerimine:** [ADR-012](../rag-v2/adr-012-resumable-indexing.md) kirjeldab külmutatud indeksiplaani, PostgreSQL-is püsivat edenemist, kuni 100 vektori kaupa laadimist/kontrolli ning lõplikku aktiveerimistehingut. Käsu piiratud jooks jätkub uues protsessis; vananenud tööõigus, muutunud allikakorpus, vigane tekst/vektor või uuem indekseerimistaotlus ei lase poolikut indeksit aktiivseks muuta. Olemasolevaid pärisvektoreid saab importida `--vectors` kaudu, puuduvaid vektoreid automaatselt ei looda. 42 testi läbisid, neist 11 uut; ESLint, RAG-i Prisma kontroll ja ainult kohaliku RAG-andmebaasi migratsioon läbisid. Mudelikutseid 0. Praegune 5000 tekstiosa piir säilib; admini ühendus ja valikuline päringulaadimine on lahti.
...
**23.09 Opuse sõltumatu ülevaatus:** [raport](../audits/rag-v2-opus-review-2026-09-23.md). Vabast olukorrakirjeldusest KOV-i kontaktini praegune rada ei jõua: sõnaline kanal eelistab stoppsõnu ja vestluse päist, KOV-kirje kaotab valla ja `relatedContacts` seose, KOV-kontaktides pole telefoni ega e-posti ning piirkonnafilter ei saa töötada. Uus avaldamisvärav blokeerib valekonfliktide tõttu 98% KOV-kirjetest ja ~54% RT XML-aktidest; ADR-011 päris valim avaldati vana `ingest()` kaudu. Soovitatud järjekord: P1 läbiv olukorrast KOV-kontaktini rada 2–3 vallaga (struktureeritud kirjed + vestluse seis samas vastusekutses), P2 keelekiht märgistatud valimil, P3 ajakirjade mahutöö ilma LLM-teadmiskoostamiseta + perioodi katvus. Enne järgmist deploy'd tuleb mõõta serveri RAG v2 skeem (deploy ei rakenda RAG v2 migratsioone) ja kitsendada piloodi kinnituse manifest.
...
1. **Korpuse vastuvõtt, maht ja käitamine:** `Andmebaasi/` algmaterjalid on kaardistatud; omaniku artiklitöö kaust ei kuulu korpusesse. Lisatud ajakirjakausta failid on serveriga võrreldud: ajakirja alus on säilinud serveri algfailid ja omaniku kinnitatud bibliograafia, kohalikud erinevused on [võrdluses](../rag-v2/journal-metadata-comparison-2026-09-07.md). Omanik lubab uut ingesti ja metaandmete uuesti loomist. KOV-i veebikorje sisu ja 1130 kirjega kontaktikoond on olemas; üldist uut korjet ei eeldata. Serveri 170 juhendi-/uuringufaili on nüüd kõik kohalikult olemas ja räsiga vastendatud; puudu olnud SKA aastaraamatu PDF taastati serverist ning uued asukohad on `Andmebaasi/REGISTER.md` ja `REGISTER.json` failides. Korrastatud sisend sisaldab 185 eri juhendi-/uuringu-PDF-i, 892 ajakirjaartiklit, 78 KOV-paketti ja 104 eri XML-akti; kontaktid ja taastatud tekstid on eraldi kasutusrolliga. Serveri 5011 tekstikirje taastatud lõigud säilivad arhiivis; 20 Maardu ID-erinevusega kirjet, Tallinna lisakirje ja varasem SHS-i tekst on eraldi võrdlussisend. Korrastus ei tähenda ingesti vastuvõtu läbimist. 07.09 serverimõõtmine kinnitas 2200 märgi tekstiridadepõhist chunkimist, PDF-only sisendit, ajutist adminiseadistust ning aktiivsest indeksist erinevat vestluse põlvkonda; [tegeliku seadistuse ja vastuvõtupuudujääkide kaart](../rag-v2/adr-009-corpus-rebuild.md) määrab järgmise ploki ulatuse. 08.09 on esimene kohalik M1 sisendiplokk valimiga kontrollitud: PDF-i metaandmekujude teisendus, HTML, Riigi Teataja XML/AKT ning KOV-/organisatsioonipakettide adapterid säilitavad päritolu ja kogumisaja. 23.09 valmis deterministliku partiinimekirja, üksikallika seisu, katkestusest jätkamise ning teksti ja embedding'u tokenimahu esimene kohalik plokk (ADR-011). 23.09 jätkuplokis valmis ülevaatuse ja partii avaldamise kohalik API/CLI, mis jätab vastuolud parandamist ootama. 23.09 valmis ka indeksi jätkatav laadimine testvektorite või salvestatud pärisvektoritega (ADR-012). 23.09 valmis valikuline kandidaatide ja sõltuvusdokumentide laadimine (ADR-013); ühe dokumendi piires peenem laadimine ning aadressiloendi edasine piiramine on veel lahti. 5000 tekstiosa piir säilib. Järgmisena vajavad teostust teadmiskandidaatide ja puuduvate pärisvektorite jätkatav mahttöö, tegeliku kulu eraldi arvestus ning adminiliidesega ühendamine. Tasuline korpusejooks vajab mõõdetud eelarvet. Versioonitud paigaldus/uuendus, õiguste eraldatus, taastamine ja kuluarvestus peavad toetama kogu toote kasutamist. [Mõõdetud sisend ja vastuvõtupiir](../rag-v2/adr-009-corpus-rebuild.md).
2. **M3 ülejäänud sõltuvuskäitumine:** dokumendisisene koostamise/valiku/indeksi rada on päriselt kontrollitud; edasi tulevad mitme dokumendi kandidaatide seostamine, parandamine ja sisuline kinnitamine ning kasutajafaktide ja ajapiiride sidumine. Algtekst ja tuletatud otsinguabi jäävad eraldi, kontrollimata seos ei muutu automaatselt kinnitatud faktiks. Suund ja JA/VÕI säilivad; vastamise tootmisühendus ja allikate eraldi esitus peavad säilitama sama tõendilepingu.
3. **Teekaardi ülejäänud võimed ja müüdav tervik:** lõpetada dokumenditöötluse puuduvad sisendijuhud, vastamine/vestlus ning ajaline ja kogu korpuse süntees vastavate M1–M6 plokkidena. Kliendiseadistused ja integratsioonilepingud täienevad konkreetse kasutusvajaduse käigus. Korduvkasutatavus säilib läbiva nõudena; eraldi arhitektuuri ümberkorraldus ei asenda toimivat funktsionaalsust ega selle tõendamist.
...
**Hinnastuse mobiilimõõdud ja sisupaigutus (20.09, serveris `39c7750b`).** Suletud võimalustega vahetab hiirerullik hinnastuse pakette vasakule-paremale; avatud võimalustega kerib sisu kaardi sees püstsuunas. Kaartide pealkiri, hind, kirjeldus, eelised ja tegevused on ühtse vahedega kompositsioonina nii mobiilis kui desktopis. Külgkaartide sisul on väike vastukalle loetavuse parandamiseks; kaardi raam ja asend säilivad. Külgkaartide pöördenurk on tavamenüüs ja hinnastuses väiksem (põhivaates 15°, viie kaardi vaates 8° ning kitsal hinnastusel 10°). Hinnastuse desktopi külgkaartide samm, kalle ja vähendus järgivad tavamenüüd; perspektiiv on kaartide otsesel vanemal. Menüüde ja hinnastuse servanooled kasutavad ühiseid ekraanipõhiseid kõrguse ja külgserva ankruid, sõltumata kaartide või lava mõõdust. Paketi valikunupp kasutab teiste nuppudega sama läbipaistvat põhja, hover-värvi ja kursorit järgivat servahelki; ainult taustahägu on hinnastuses välja lülitatud. Vilksatuse kadumine selle kombinatsiooniga vajab omaniku visuaalset kontrolli. Kõrge kontrasti värv säilib. Võimaluste link on valikunupust suurema vahega allpool. Eeliste loendi linnukesed on suuremad ja joondatud teksti esimese reaga. Nupp ja link jäävad eeliste lähedale; pikk sisu kerib algusest. Kaardid paiknevad madalamal ning säilitavad seadmekohased mõõdud. Visuaalne runtime `NOT_PROVEN` — omanik testib ise.
...
sisuala arvestab doki kõrgust. Landscape säilib. Visuaalne runtime not_run
...
[Raport](../audits/workspace-mobile-swipe-2026-09-20.md); päris iOS NOT_PROVEN.
...
tootmise HTML/DOM ning Sisenen-puutekatse kontrollitud, frontend aktiivne.
