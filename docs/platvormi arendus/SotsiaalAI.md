...
**Aardvarki Teenusekaardi privaatsusleid on parandatud.** Autenditud avaliku abikuulutuse
märksõna- ja piirkonnaotsing ei kasuta enam väljundist teadlikult eemaldatud pealkirja,
kirjeldust, struktureeritud kokkuvõtet ega täpset vabatekstilist asukohta, mistõttu otsingu
tulemusse kuulumine ei saa nende privaatväljade vasteid reeta. Järgmine tööots valitakse S4-st.
