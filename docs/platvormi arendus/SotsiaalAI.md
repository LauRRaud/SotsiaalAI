...
**07.09 dokumendi ja metadata lisamisvoo serveri tervikahel läbis; vastuse sisuline vastuvõtt on PARTIAL.** Rakendusesiseses brauseris kontrolliti PDF/metadata lisamist, kaheksa dokumendi indeksi avaldamist olemasolevate vektoritega, värsket otsingut, tegelikku assistendi juhist/allikaid ning nähtavat vastust koos algallika ja lehe värskendamisega. [Katseraport](../audits/rag-v2-admin-intake-local-2026-09-07.md) kirjeldab tõendid ja rahastusvea: vastus liitis projektide ning arendusprogrammi eri meetmed kokku, kuigi õige eristus oli allikas olemas. Katse kasutas kaks mudelikutset; kuluregistri arvestus 0,008230760 USD. Ajutine käivitusluba on suletud ja varasem serveriseadistus taastatud. Järgmine plokk on rahastuse objekti/meetme seose säilitamine vastuses; T1/T5, F1/F4 ja isikupiiri semantilised lahtised otsad säilivad.
