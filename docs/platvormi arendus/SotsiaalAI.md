...
**Aardvarki kõnesalvestuse turvajärelkontroll on parandatud.** Auditi kirjutuse tõttu
tagasipöördunud stopitehing ei jäta enam juba finaliseeritud tundlikku heli omanikuta:
objekt koristatakse kohe või jääb kustutustõrkel viidatud `DELETE_PENDING` reale, mille
sweep saab viivitamata uuesti võtta. Järgmine tööots valitakse S4-st.
