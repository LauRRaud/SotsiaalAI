...
**31.08 vastusepõhine RAG-diagnostika ja automaatne Markdowni koondaruanne on omaniku korraldusel lisatud otse `main`-i.** Administraator näeb enda eravestluses küsimust, vastust, katset, tuvastatud tõrke etappi ja põhjuskoodi koos puuduvate tõendite piirangutega; vana vastuse nupp ei vaheta korduskatsel tähendust. [Leping, kasutus ja piirid](../audits/rag-susteem-master.md#135-vastuse-diagnostika-ja-automaatne-vestlusaruanne). Järgmine samm on omaniku autenditud serverivaate kontroll pärast väljalaset. Kogu75/37 ei käivitata selle töö osana ning automaatkontroll ei tõenda iseenesest sisulist õigsust ega algpõhjust.
