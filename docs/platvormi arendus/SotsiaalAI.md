...
**Materjalide sanitiseeritud derivaadi kustutusjääk on parandatud.** Üleslaadimisel seotakse
sanitiseeritud fail nüüd esitisega enne RAG-importi ning tema säilituskell algab kohe, mistõttu
tagasivõtmine, konto kustutus ja tähtajaline retention ei saa importimata tekstikoopiat kettale
jätta. Järgmine tööots valitakse S4-st.
