...
**Organisatsiooni eelpöördumise paranduse turvaauk on suletud 15.08.** Parandatud versiooni
postkasti saatmine kontrollib nüüd uuesti globaalset vastuvõtuväravat, organisatsiooni aktiivset
olekut ja aktiivset `KOV_INTAKE` moodulit; suletud kanali korral ei looda asenduspöördumist ega
postkastikirjet. Järgmine tööots valitakse S4-st.
...
Organisatsiooni postkasti saadetav parandatud eelpöördumine kontrollib saatmise hetkel uuesti
globaalset vastuvõtuväravat, organisatsiooni aktiivset olekut ja aktiivset `KOV_INTAKE` moodulit.
