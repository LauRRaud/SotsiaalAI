...
**Aardvarki madala raskusastmega kliendijõudluse leid on parandatud.** Jagatud `Button` ei
suuna enam kõiki primary-nuppe eraldi WebGL-konteksti, globaalse pointer-kuulari ja lõputu
animatsioonitsükliga `SpecularButton`-isse; olemasolev CSS-põhine primary/glow kujundus ning
nupu käitumisleping säilivad. Järgmine tööots valitakse S4-st.
