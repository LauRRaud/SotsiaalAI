...
**Aardvarki leitud välitöö detailipäringute regressioon on parandatud.** Muutumata avatud
paketi dekrüptimine ei uuenda enam Reacti paketi viidet ega käivita seetõttu uut autentitud
detailipäringut; tegelik olekumuutus ja sulgemise kohene kustutus jõuavad endiselt vaatesse.
