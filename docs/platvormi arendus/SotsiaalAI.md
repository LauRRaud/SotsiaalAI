...
**Kiire abi koondi turvajärelkontroll on parandatud.** Admini kuupäevafiltriga vastus ei avalda
enam k-anonüümsuse künnisest mööduvat sündmuste toorreaarvu; kogu valimi lehekülgitamine,
inimestepõhised koondid ja nähtav kärpeseis säilisid. Järgmine tööots valitakse S4-st.
