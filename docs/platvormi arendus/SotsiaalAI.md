...
**RAG-i viimane deployitud koodirelease on `97f476730035f221a6216aabb7516e6f776038b5` (27.08); kogu süsteem on endiselt PARTIAL.** Release lisas olemasoleva originaal-FTS5 ja `text-embedding-3-large` dense-kanali kõrvale EstNLTK/Vabamorfi eraldi eesti lemma-FTS shadow-indeksi, mis katab sama registripõlvkonna 49 727 lõiku / 6073 aktiivset dokumenti, kuid ei muuda veel fusion'it, top-k-d, kontekstivalikut ega vastust. Täisdeploy järel kattusid kohalik kood, `origin/main`, puhas server ja aktiivne frontend-artifakt SHA-l `97f47673`; kolm teenust olid aktiivsed, `/vestlus` vastas 200 ning mõlemad FTS5 indeksid olid `ready=true`. 12 käsitsi autentitud küsimusest jõudis RAG-i 10; neis käivitus 29/29 shadow-vaatlust. Lemma leidis J07, J08 ja mõlema J18 sõnastuse puhul õige dokumendi, kuid ei parandanud hilisemaid slot-, identity-, validation- ega attribution-vigu. J07 andis `678 / 273 / 21 600 / 12 / 43` ja õige avatava 2022 allika; J08 kaotas endiselt `26%`, J18 lühike autoriankur keeldus, kaks töötajaküsimust läksid enne RAG-i ekslikult KOV-kontaktirajale ning multi-year küsimus jäi põhjusega `cross_source_numeric_mix` fail-closed. Shadow lisas käivitunud voorudes keskmiselt 2192 ms ja multi-year voorus 8023 ms, mistõttu production-promotion vajab enne unikaalsete kandidaatide tõendiväärtuse auditit ning shadow viimist kriitilisest vastuseteest välja või batch'imist. `FINAL_SHA` ega 75/75 staatust ei anta; range aktiivse release'i vaade on **DONE 1/75 · NOT_PROVEN 74/75**. Järgmine sidus töö on lemma promotion-readiness audit koos eraldi route-/slot-/identity veaklasside parandamise järjekorraga, mitte embedding-mudeli ega originaal-FTS-i väljavahetamine.
