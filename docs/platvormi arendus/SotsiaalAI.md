...
**Aardvarki leitud Välitöö recovery-importi turvaauk on parandatud.** Kliendi kontrollitavad
`recoveryImport` ja tagantjärele muudetav `deviceCreatedAt` ei ava enam suletud külastust:
märkmed ja manused saavad alati 409 ning liidesest eemaldati eksitav taastamistee. Ajalooline
taastepäritolu jääb andmekoopias nähtavaks; mitme seadme taastamine vajab edaspidi serveri
tõendatavat manifesti. Järgmine tööots valitakse S4-st.
