...
**07.09 M4 tõendiosadega kandidaat on kohalikult valmis; järgmine samm on kuue paari võrdluse käivitamisotsus.** Vastuse koostaja valib katsekandidaadis muutmata algteksti osi tunnustega, rakendus taastab nende tõendi ise. [Kohalik kontroll, võrdlusplaan ja tervikahela vastuvõtt](../audits/rag-v2-evidence-segments-local-2026-09-07.md) on kirjas, kuid pärismudeli sisuline kasu on tõendamata. Piloodi lõpetamiseks tuleb läbida ka tegelik dokumendi ja metadata ettevalmistuse, ingesti, indekseerimise, värske otsingu, assistendi juhise ning nähtava vastuse ja allika rada; kitsas vastamisvõrdlus seda ei asenda. Omaniku juhisel ei kulutata aega peenele käsitsi kuluarvutusele. Uut katset ega serveripaigaldust pole tehtud; F1/F2/F4 ja muud baasi/M2/M4/M6 lahtised leiud säilivad. Jätkuvestlusega sidumine järgneb soodsale võrdlustulemusele; F3/O1 ja isikupiiri senise tõendi ulatust ei laiendata.
