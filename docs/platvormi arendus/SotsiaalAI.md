...
**Aardvarki võrgustikujagamise aegumissweep'i järelleid on parandatud.** Sama päeva eri
jagamiste END-sündmused kasutavad nüüd ressursipõhist idempotentsusvõtit, mistõttu iga lõpetatud
jagamine jätab eraldi elutsükli- ja audititõendi; järgmine tööots valitakse S4-st.
