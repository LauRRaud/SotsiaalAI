...
**Aardvarki teenusepakkuja alamkirjete staatuse leid on parandatud.** Olemasoleva teenuse või
teeninduskoha `PUBLISHED` → `HIDDEN`/`DRAFT` tagasivõtmine jõuab nüüd salvestusse, samal ajal kui
varasem kaitse peidetud alamkirje vaikiva taasavaldamise vastu säilib. Järgmine tööots valitakse
S4-st.
