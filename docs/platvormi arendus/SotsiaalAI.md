...
leksikaalajaga täielikud, mitte partial/degraded. Autentitud vastus/allikapaneel ning uue ingest'i,
reindex'i ja kustutuse päris taustasünkroonsus on veel **NOT_PROVEN**.
...
| 33 | **Püsiva FTS5 leksikaalindeksi lõppvärav.** Runtime-release `d08b25a8` on toodangus: 49 727 aktiivset lõiku / 6073 aktiivset dokumenti, health ready ja kolm laia otsingut 512–537 ms leksikaalajaga täielikud. Autenditud `/vestlus` vaade avanes, kuid enne DONE seisu on veel vaja sama SHA vastust/allikapaneeli ning päris ingest/reindex/tombstone taustasünkroonsuse kontrolli. V04 lühikese otsepäringu pärand-sõnastustundlikkus ja 54/75 mõõtmata juhtumit jäävad eraldi avatuks | vestlus / RAG jõudlus | PARTIAL |
