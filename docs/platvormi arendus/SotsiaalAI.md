...
**31.08 release'i `95104077` kahefaasiline in-app kordus ja omaniku tellitud põhjuseanalüüs on lõpetatud:** 8 vastust, 3 PASS / 3 PARTIAL / 2 FAIL. M01 läbis mõlemad; M02 ebaõnnestus mõlemad; integreeritud teenused jäid mõlemad PARTIAL-iks ning lapse heaolu isolated PARTIAL / sequential PASS. Kõik täisvastused ja paaristatud serverijäljed on [vahelogi kaudu leitavad](../../eval/luna-retest-progress.md). [Diagnoos](../audits/evidence/rag-retest-2026-08-31-95104077/diagnosis.md) tõendab M02 vale soovituslepingu, allikakatte 64-väite piiri, üldsõnadest tekkiva vale väitetoe, aastaarvu eraldamise tõttu peidetud allika ning sõltumatu sünteesi ajaloo-/skoorilekke. EstNLTK töötas kõigis kaheksas päringus; eraldi lemma-FTS jäi shadow-only. Mõõdetud local/origin/server HEAD oli `c405d3ca`, runtime-kood muutmata. Diagnoosis koodi ega serverit ei muudetud ja küsimusi ei korratud. Järgmine samm on diagnoosi kitsad põhjusparandused ainult omaniku korraldusel, seejärel sama kahefaasiline kordus ja paus; automaatjätk jääb PAUSED.
