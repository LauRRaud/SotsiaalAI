...
stale'iks ning taastab seejärel uue tervikliku põlvkonna; ebaõnnestumisel jätkub dense-otsing,
kuid vastus märgitakse täpse põhjusega `partial/degraded`. Admin saab seisu kontrollida ja
platvormiadmin indeksi võtmega uuesti ehitada. Ohutus runtime tõendas 49 727/6073 täieliku katte,
