...
**Aardvarki SOL-PAY-09 järelleid on suletud.** Konto kustutamise järel hilinenud `PAID`
webhook säilitab nüüd tasutud arvestuskirje ja auditi, kuid ei proovi nullitud tellimust aktiveerida;
provider saab eduka vastuse, mitte tehingu rollback'ist 500. Järgmine tööots valitakse S4-st.
