...
**RAG-i külmkäivitus ja deploy-ressursid on 23.08 põhjusepõhiselt optimeeritud; RAM-i ei suurendatud.** Sisulise RAG-i baasseis on `815f15f6` ja mõõdetud jõudlus-release `5796178f`. Tootmiskujul startup-warmup vähendas esimese lihtsa autoripäringu retrieval'i 9,94 sekundilt 2,43 sekundile ning dense-aja 7,84 sekundilt 0,263 sekundile; brauserivastus saabus 7,10 sekundiga. Deploy peatab build'i ajaks frontend'i, RAG-i ja research-workeri, jättes mõõdetult 5,3 GiB mälu vabaks. 104 aegunud frontend-artefakti eemaldamine vähendas deploy-backup'id 8,5 GiB-lt 113 MiB-ni ja juurketta kasutuse 96%-lt 79%-ni; DB-backup'e ei kustutatud. V04 kuue tõendipäringu retrieval on veel 10,49 s: suurema paralleelsuse katse aeglustas selle 17,06 sekundini ja võeti tagasi, kuid vastus säilitas 10%/640, 6%/227, 2%/100 ning avatud paneel näitas Anu Lepsi 2025 artiklit. Korpust, indeksit, DB-d ega env-i ei muudetud. Range seis on endiselt **DONE 21/75 · PARTIAL 0/75 · FAIL 0/75 · NOT_PROVEN 54/75**, mitte kogu RAG-i 10/10. Järgmine sidus töö on V04 dubleeriva fanout'i vähendamine või batch'imine ja seejärel ülejäänud 54 juhtumi värav plokkidena.
