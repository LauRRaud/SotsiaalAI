...
**05.09 M0–M2.2 ja M2 mitme allika järelkatse on lõpetatud ning serveris; lõplik käituskood on `7d1e1fd5d`.** Kaheksa pärisallika, 15 uue perekonna / 21 küsimuse ja 9 regressiooniküsimuse manifest taaskasutas 25 vana vektorit ning tegi 73/73 edukat `text-embedding-3-large` kutset, 23 554 tegeliku tokeni ja 0,003062020 USD arvestusliku kuluga; korduskatseid ja genereerivaid kutseid oli 0. Uue kogumi 18 täieliku sisuküsimuse lõppkontekstis sai puhas vektor vajaliku toe 15/18, hübriid 13/18, struktuurirada 11/18 ja leksikaalne 7/18; esimest korda avatud kontrollosas olid tulemused vastavalt 5/7, 3/7, 2/7 ja 3/7. Algne regressioon säilis vektori/hübriidi lõppkontekstis 6/6, kuid hübriidi top-1 langes konkureerivate allikatega 6/6-lt 4/6-le. Struktuur parandas ühe, halvendas kolme juhtumit ja jääb vaikimisi välja; runtime ei tuvasta veel korpuse ebapiisavust. Töö käigus parandati PDF NUL → PostgreSQL `22P05` ning uue raportikaustaga kulu lähtestanud ledger-juur; fikseeritud juure kordus tegi 0 API-kutset ja sama tulemuse. 61 RAG-testi, ledger'i 15 sihttesti, lint, diff-kontroll, i18n ja lõplik build on rohelised; täielik [järelkatse audit](../audits/rag-v2-multi-source-preparation-2026-09-05.md) säilitab juhtumid ja tõendid. Järgmine soovitatud plokk on M2.3: arendusosal parandatav fusioon/dokumendidiversiteet, struktuur vaikimisi väljas ja kinnituseks uus puutumatu kontrollosa; Luna, M3, HTTP-autentimine ning kasutaja chat jäävad `NOT_PROVEN`/`retired`.
