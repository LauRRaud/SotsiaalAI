...
**Aardvarki O-JTA-6 järelkontrolli terviklünk on parandatud.** Purge'itud kohtumise
ettevalmistuse konteiner on nüüd kõigil muutmisradadel kirjutuskaitstud: selle aega ei saa
muuta ega markerit koos säilitatud seostega kõvasti kustutada. Järgmine tööots valitakse S4-st.
