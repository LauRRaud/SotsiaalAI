...
**SOL-SPROF-01 konto kustutuse omandipiiri regressioon on parandatud.** Puhastus valib nüüd
ainult inimese SOLO-profiilid; organisatsiooniprofiili ajalooline `ownerId` ei võimalda konto
kustutamisega organisatsiooni avalikku profiili, kaardikirjet ega RAG-koopiat peita.
