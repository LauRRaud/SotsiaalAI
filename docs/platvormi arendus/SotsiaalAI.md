...
**07.09 M4 7+7 pärisvõrdlus on ette valmistatud; paigaldus ootab selgesõnalist push-luba.** Omanik tühistas piloodi loa ja katseandmete tähtajapiirangud ning lubas alustada võrdlust. Kohalik commit `4c7560f3c` toetab tähtajata M4 kirjeid ja samade fikseeritud pakettide kasutamist ilma embedding'u või uue otsinguta; sihttestid, lint, skeemikontroll ja build läbisid. Automaatne õiguste kontroll peatas push'i, mistõttu serveri tähtajad on veel tehniliselt muutmata ja päriskutseid on 0. [Raport ja valmis plaanid](../audits/rag-v2-evidence-draft-local-2026-09-07.md) määravad 7 baas- ja 7 kandidaatvastust, kokku kuni 0,27 USD. V3 baasrada ja õiguskontrollid säilivad; kandidaadi sisuline kasu on NOT_PROVEN. V3 avaldamisparandus jääb lõpetatuks, M4 avalik vastuvõtt lahtiseks ning M2/M2.3 kinnitused ja seitse lahtist juhtumit säilivad.
