...
**Aardvarki Teenuspäeviku suunamisvaliku leid on parandatud.** Mitme aktiivse suunamisega
kliendi kirjet ei saa enam salvestada suunamiseta: vorm annab omakeelse veateate ning server
jõustab sama nõude ka API ja võrguta järjekorra jaoks. Järgmine tööots valitakse S4-st.
