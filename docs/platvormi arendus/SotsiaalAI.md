...
**Aardvarki SOL-DOC-04 järelleid on parandatud.** Staging-helper taastab olemasoleva transkripti
ka siis, kui vana faili varundamine õnnestub, kuid uue faili avaldamine katkeb; ajutised ja
varufailid koristatakse. Järgmine tööots valitakse S4-st.
