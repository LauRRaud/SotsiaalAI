...
| 32 | **V04 kuue tõendipäringu retrieval-fanout.** Pärast külmkäivituse sulgemist võtab V04 retrieval endiselt 10,49 s. Kuue päringu ühe laine katse tekitas Chroma/SQLite'i konkurentsi ja halvenes 17,06 sekundini, seega rohkem paralleelsust ei kasutata. Mõõda ja vähenda dubleerivat tööd või batch'i embedding/dense päringud nii, et 10%/640, 6%/227, 2%/100, 2023/2024 ja toetav allikas jäävad muutumatuks | vestlus / RAG jõudlus | SABA |
