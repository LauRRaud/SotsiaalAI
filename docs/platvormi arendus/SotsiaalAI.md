...
**Aardvarki Teenuspäeviku säilitusjärelleid on suletud.** Väljastatud `SERVICE_LOG_REPORT`
säilitab nüüd oma serveri määratud liigi ka omaniku dokumendi-PATCH-is, mistõttu raportit ei saa
enne DELETE-i ega konto kustutust tavaliseks materjaliks ümber klassifitseerida. Järgmine tööots
valitakse S4-st.
