...
**J11 ühe uuringu faktipäringu P0-parandus on 22.08 toodangus ja kahe sõnastusega päris vestluses tõendatud (`735ff837`).** Üldine `specific_research_fact` rada tuvastab enne faktisegmenti konkreetse uuringudokumendi, välistab uuringu identiteedikonkureerijana sama sõnavaraga õigusallika ning kontrollib vastuse arve ainult sama dokumendi renderdatud tõendist. Eesti arvsõnad ja numbrikujud on täpse faktivärava mõlemal poolel võrreldavad; see sulges vale `no_numeric_claim`/`unsupported_numeric_claim` keeldumise ilma ühe küsimuse hardcode'ita. Samas autentitud vestluses, ilma „Uus vestlus” workaround'ita, vastas lühike variant õigesti 7/6/1 intervjuud 19,9 sekundiga ning Elin Küti nimega variant 11,1 sekundiga. Mõlemal oli ainus kuvatud allikas Elin Kütt, 2016, „Sotsiaaltöötajate tööalase toetuse kogemused”, Sotsiaaltöö 3/2016, lk 64–68; lühikese vastuse trace kinnitas `all_claims_in_one_rendered_source` arvudele 7, 6, 1 ja 3. `origin/main`, server ja mõõdetud brauser olid SHA-l `735ff837`; frontend, RAG ja research-worker aktiivsed, health 49 727 vektorit / 6089 dokumenti. See teeb kaks J11 vormi DONE, mitte kogu 75 juhtumi RAG-i 10/10: ülejäänud täielik deploy-järgne maatriks ja jõudluse parandamine on endiselt lahti.
