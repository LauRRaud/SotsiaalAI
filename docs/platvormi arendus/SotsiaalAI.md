...
**Väljumise kasutajaliides (20.09, serveris `1b30a83f`).** Tahtlikul väljumisel ei ava sessiooni kadumine vahepeal automaatset sisselogimisakent. Üleminek lõpeb avalehe ühendamisnupul; ebaõnnestunud väljumine vabastab piirangu. Visuaalne runtime `NOT_PROVEN`, omanik testib ise.
