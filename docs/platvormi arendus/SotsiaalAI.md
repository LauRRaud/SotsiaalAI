...
**Aardvarki teekonna jagamismanifesti saadavusleid on parandatud.** Manifest on nüüd piiratud
lubatud võtmete arvuga, üksiku võtme pikkus on piiratud ja duplikaadid eemaldatakse lineaarse
`Set`-kontrolliga; järgmine tööots valitakse S4-st.
