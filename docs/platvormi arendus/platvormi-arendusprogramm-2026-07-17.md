...
| 2026-07-18 | Kohalik main konsolideeritud (26 haru) | Integratsiooniharu `integration/2026-07-18` → `main @ 0ea13453` (lokaalne ff; server puutumata, origin/main 66 taga). Sees: Faas-1 P0/P1 kiht (17 haru), T17, T11, T04+T05 stack, T06, T28, supervision-v0-skeem, registri jaamalend. Värav: 1551/1551 testi, i18n, `db:migrate:check` 96 migratsiooni, lint 0 viga, build PASS. Üks integratsiooni-fix: check-env spawn hermeetiliseks (`pollAndWorkerWarnings.test.js`). EDASI LÜKATUD disainikollisiooni tõttu: T03 `chat-voice-v1` (vana spatial-entry vs main'i uus mic-lahendus), T02 `account-v1` + T16 `export-v1` (verify-then-swap vs kohene e-posti swap) — vajavad sihitud lepitussessioone. Leid: `.env`-is `SUBSCRIPTION_RECURRING_ENABLED` ilma `MAKSEKESKUS_PUBLIC_KEY`-ta kukutaks deploy check-env'i. Backup'id: `backup/main-pre-sync-2026-07-18`, `backup/main-pre-integration-2026-07-18`. T10 leping uuendatud uuele baasile; T24/T23 jätkuvad omades worktree'des. Koordineerimise võttis üle kasutaja. |
